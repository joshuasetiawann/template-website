# Pulsedeck — SaaS Product Landing Page Template

A complete, dependency-free landing page template for Pulsedeck, a fictional saas product brand, styled as a centered SaaS-style layout with a CSS-built product mock.
...
- `index.html` — the Pulsedeck landing page (all sections in-page).
...
- `--text` (#16182E) and `--muted` — type colors
- `--accent` (#4F46E5) and `--accent-2` (#818CF8) — brand colors used by buttons, links and gradients
