# Bookmint — Booking Platform Landing Page Template

A complete, dependency-free landing page template for Bookmint, a fictional booking platform brand, styled as a split-hero product layout with feature tabs and animated stats.
...
- `index.html` — the Bookmint landing page (all sections in-page).
...
- `--text` (#173B36) and `--muted` — type colors
- `--accent` (#0D9488) and `--accent-2` (#E8C893) — brand colors used by buttons, links and gradients
- `--accent-soft`, `--border`, `--shadow` — tints, hairlines and elevation
- `--radius` (14px) / `--radius-lg` — corner rounding across all components
- `--container` (1170px) — page max-width
