# Daybloom — Mobile App Landing Page Template

A complete, dependency-free landing page template for Daybloom, a fictional mobile app brand, styled as a split-hero product layout with feature tabs and animated stats.
...
- `index.html` — the Daybloom landing page (all sections in-page).
...
- `--text` (#1D1E36) and `--muted` — type colors
- `--accent` (#6366F1) and `--accent-2` (#FF7E6B) — brand colors used by buttons, links and gradients
- `--accent-soft`, `--border`, `--shadow` — tints, hairlines and elevation
- `--radius` (20px) / `--radius-lg` — corner rounding across all components
- `--container` (1150px) — page max-width
