/* Inkwell Academy — Online Course | landing page interactions (vanilla JS, no dependencies) */
...
(function () {
  ...
  var SITE = {
    ...
    successMsg: "Welcome to Inkwell. Module one arrives Sunday morning.",
    successBtn: "Seat reserved ✎",
  ...
  function bumpCounter() { /* no counter on this page */ }
  ...
  if (rlAnnounce) {
    var rlAnnKey = "inkwell-announce-dismissed";
    var rlAnnSaved = null;
