# Redline Studio — Agency Offer Landing Page Template

A complete, dependency-free landing page template for Redline Studio, a fictional agency offer brand, styled as a split-hero product layout with feature tabs and animated stats.
...
- `index.html` — the Redline Studio landing page (all sections in-page).
...
- `--text` (#111111) and `--muted` — type colors
- `--accent` (#E63946) and `--accent-2` (#111111) — brand colors used by buttons, links and gradients
- `--accent-soft`, `--border`, `--shadow` — tints, hairlines and elevation
- `--radius` (2px) / `--radius-lg` — corner rounding across all components
