# Scholarpath — Education Platform Landing Page Template

A complete, dependency-free landing page template for Scholarpath, a fictional education platform brand, styled as a centered SaaS-style layout with a CSS-built product mock.
...
- `index.html` — the Scholarpath landing page (all sections in-page).
...
- `--text` (#1A2540) and `--muted` — type colors
- `--accent` (#1E3A8A) and `--accent-2` (#D9A52B) — brand colors used by buttons, links and gradients
