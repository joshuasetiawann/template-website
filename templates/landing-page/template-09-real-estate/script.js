/* Aurelia Estates — Real Estate | landing page interactions (vanilla JS, no dependencies) */
...
(function () {
  ...
  var SITE = {
    ...
    successMsg: "Thank you. A partner will write to you within one business day.",
    successBtn: "Received ✓",
  ...
  if (rlAnnounce) {
    var rlAnnKey = "aurelia-announce-dismissed";
    var rlAnnSaved = null;
