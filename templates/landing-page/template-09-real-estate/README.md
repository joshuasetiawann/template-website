# Aurelia Estates — Real Estate Landing Page Template

A complete, dependency-free landing page template for Aurelia Estates, a fictional real estate brand, styled as an editorial, typography-led narrative layout.
...
3. Stats band
4. Narrative problem-to-solution prose
5. Numbered feature list
6. Benefit split with gradient figure
7. Pull-quote testimonials
8. FAQ accordion
9. Final call-to-action
10. Footer with link columns and social icon buttons

## Pages

- `index.html` — the Aurelia Estates landing page (all sections in-page).
...
- `--bg` (#F7F4EE) and `--surface` / `--surface-2` — page and card backgrounds
- `--text` (#2A251E) and `--muted` — type colors
- `--accent` (#9C7A4D) and `--accent-2` (#C9A86F) — brand colors used by buttons, links and gradients
- `--accent-soft`, `--border`, `--shadow` — tints, hairlines and elevation
- `--radius` (3px) / `--radius-lg` — corner rounding across all components
- `--container` (1160px) — page max-width
