/* The Margin — Newsletter | landing page interactions (vanilla JS, no dependencies) */
...
(function () {
  ...
  var SITE = {
    brand: "The Margin",
    successMsg: "Welcome to the margins. Issue No. 143 arrives Sunday.",
    successBtn: "Subscribed ✓",
  ...
  if (rlAnnounce) {
    var rlAnnKey = "themargin-announce-dismissed";
    var rlAnnSaved = null;
