# Lakeshore Parks & Recreation — Parks & Recreation Department Template

Parks, pools, trails and programs for every age across the district.

A full-release, multi-page government & public website template. Every navigation item leads to a real, filled page. Built with the **Vibrant Culture** design variant: Warm green and sun-amber with a leaf-and-sun recreation motif.

## Features

- Four complete pages — home, about, programs & parks and contact — fully linked
