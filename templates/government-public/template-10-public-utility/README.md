# Brightwater Utilities — Public Utility District Template

Reliable water and clean power, owned by the community it serves.

A full-release, multi-page government & public website template. Every navigation item leads to a real, filled page. Built with the **Modern Accessible** design variant: Accessible teal-blue with a water-drop and power-line motif.

## Features

- Four complete pages — home, about, account & services and contact — fully linked
