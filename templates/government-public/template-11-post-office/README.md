# Northgate Postal Service — National Postal Service Template

Letters, parcels and money services delivered to every address.

A full-release, multi-page government & public website template. Every navigation item leads to a real, filled page. Built with the **Vibrant Culture** design variant: Warm heritage terracotta and gold with an eagle-and-envelope postal crest.

## Features

- Four complete pages — home, about, mail services and contact — fully linked
...
Part of the **government-public** category of the template library — one of 20 distinct, self-contained multi-page templates (Vibrant Culture variant). Content is fictional and for demonstration only.
