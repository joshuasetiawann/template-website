# Wexford Public Library — Public Library System Template

Free books, ideas and gathering space for every Wexford resident.

A full-release, multi-page government & public website template. Every navigation item leads to a real, filled page. Built with the **Modern Accessible** design variant: Clean accessible blue with large readable type and an open-book motif.

## Features

- Four complete pages — home, about, visit & borrow and contact — fully linked
...
Part of the **government-public** category of the template library — one of 20 distinct, self-contained multi-page templates (Modern Accessible variant). Content is fictional and for demonstration only.
