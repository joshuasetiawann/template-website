# Reyes for Governor — Statewide Campaign Template

A fair economy, great schools and clean energy for every family.

A full-release, multi-page government & public website template. Every navigation item leads to a real, filled page. Built with the **Campaign Energetic** design variant: Patriotic navy and red with a rising-star motif and bold condensed headlines.

## Features

- Four complete pages — home, about, the plan and contact — fully linked
