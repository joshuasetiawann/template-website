# Rivergate Public Health — Public Health Department Template

Protecting community health through prevention, data and care access.

A full-release, multi-page government & public website template. Every navigation item leads to a real, filled page. Built with the **Bold Emergency** design variant: Bold health-red and deep teal with a caduceus-cross motif.

## Features

- Four complete pages — home, about, health services and contact — fully linked
