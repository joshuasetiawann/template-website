# National Census Bureau — National Statistics Agency Template

Accurate population data that guides funding and representation.

A full-release, multi-page government & public website template. Every navigation item leads to a real, filled page. Built with the **Modern Accessible** design variant: Accessible data-blue with a bar-chart and grid motif.

## Features

- Four complete pages — home, about, data & services and contact — fully linked
