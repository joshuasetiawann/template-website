# Vote Glenshire — County Elections Office Template

Register, check your status and find your polling place — every election.

A full-release, multi-page government & public website template. Every navigation item leads to a real, filled page. Built with the **Campaign Energetic** design variant: Patriotic navy and red with a ballot-check and star motif.

## Features

- Four complete pages — home, about, voter services and contact — fully linked
