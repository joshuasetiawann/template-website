# MetroLink Transit — Regional Transit Authority Template

Buses, light rail and paratransit connecting the whole region.

A full-release, multi-page government & public website template. Every navigation item leads to a real, filled page. Built with the **Modern Accessible** design variant: Accessible signal-blue with a route-line motif and oversized type.

## Features

- Four complete pages — home, about, riding & fares and contact — fully linked
