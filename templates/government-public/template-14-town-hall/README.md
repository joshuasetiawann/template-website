# Town of Briarcliff — Town Government Template

Small-town government, close to the 22,000 people it serves.

A full-release, multi-page government & public website template. Every navigation item leads to a real, filled page. Built with the **Official Civic** design variant: Heritage navy and brick-red with a town-hall building crest.

## Features

- Four complete pages — home, about, town services and contact — fully linked
