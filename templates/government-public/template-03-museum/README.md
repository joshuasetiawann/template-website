# Harborline Museum — Civic Museum Template

Five centuries of art and regional history, free to the public.

A full-release, multi-page government & public website template. Every navigation item leads to a real, filled page. Built with the **Vibrant Culture** design variant: Warm terracotta and gold with a gallery-arch motif.

## Features

- Four complete pages — home, about, visit & exhibitions and contact — fully linked
