# City of Ashford Bay — Municipal Government Template

Serving 184,000 residents with open, accountable local government.

A full-release, multi-page government & public website template. Every navigation item leads to a real, filled page. Built with the **Official Civic** design variant: Navy and civic red with a layered city crest motif.

## Features

- Four complete pages — home, about, departments and contact — fully linked
