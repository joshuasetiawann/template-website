# Office of Citizenship & Immigration — Immigration Services Agency Template

Clear pathways to visas, residency and citizenship for newcomers.

A full-release, multi-page government & public website template. Every navigation item leads to a real, filled page. Built with the **Campaign Energetic** design variant: Patriotic navy and red with a passport-and-torch welcome motif.

## Features

- Four complete pages — home, about, immigration services and contact — fully linked
...
Part of the **government-public** category of the template library — one of 20 distinct, self-contained multi-page templates (Campaign Energetic variant). Content is fictional and for demonstration only.
