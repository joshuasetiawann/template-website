# Saltline & Tide — Coastal Seafood Restaurant Template

Saltline & Tide is a foam-and-navy coastal seafood template with a raw bar menu, daily catch board, wave dividers and reservation form.
...
- Hero — Whatever the boats bring in, we cook tonight.
- Menu (Raw Bar / Mains / Shareables / Dessert)
- Feature band
- Our story — Rosa Delmar & Tomás Rivera
