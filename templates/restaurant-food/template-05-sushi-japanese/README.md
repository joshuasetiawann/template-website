# Kanade — Sushi & Japanese Kitchen Template

Kanade is a minimal ink-and-vermilion sushi template with an omakase menu, counter seatings, zen gallery and reservation form.
...
- Hero — Fish, rice, silence.
- Chef — Sato Kenji
- Menu (Omakase / Nigiri / Small Plates / Sake & Tea)
- Feature band
