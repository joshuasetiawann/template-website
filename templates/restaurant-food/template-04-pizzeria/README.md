# Rosso Forno — Wood-Fired Pizzeria Template

Rosso Forno is a bold red-and-basil pizzeria template with menu tabs, a 3-step order band, floating dish cards and an order form.
...
- Hero — Blistered crust. Zero shortcuts.
- Menu (Classics / Signature / Calzoni / Sides & Sweets)
- How-it-works steps
- Our story — Gia & Paolo Russo
