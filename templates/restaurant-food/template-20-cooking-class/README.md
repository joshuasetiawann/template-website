# Copper Spoon Atelier — Cooking Class Studio Template

Copper Spoon Atelier is a paper-and-saffron cooking school template with a recipe-card class schedule, instructor story and class booking form.
...
- Booking form (name, email, date, headcount) with inline error states and a success message (browser-side only)
...
- How-it-works steps
- Menu (Weeknight Series / Weekend Intensives / Kids & Family / Masterclasses)
- Daily specials board
- Our story — Rosa Lindqvist
