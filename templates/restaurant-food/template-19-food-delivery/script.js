/* ==========================================================
   Platerunner — Food Delivery Service
   template-19-food-delivery (layout V2)
   Vanilla JS: mobile nav, menu tabs, form validation,
   scrollspy, scroll-reveal, back-to-top, promo bar
   ========================================================== */
(function () {
  'use strict';
  ...
  /* ---------- promo bar dismiss ---------- */
  var promo = qs('[data-promo]');
  var promoClose = qs('[data-promo-close]');
  if (promo && promoClose) {
