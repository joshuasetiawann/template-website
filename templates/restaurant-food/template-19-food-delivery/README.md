# Platerunner — Food Delivery Service Template

Platerunner is an app-clean food delivery template with a phone-mock hero, trending dishes menu, a 3-step order band and address-validated checkout form.
...
- Layout: **V2 casual promo — announcement bar, centered hero, menu tabs and an order CTA band with steps**
...
- Delivery address checker (name, email, address) with inline error states and a success message (browser-side only)
...
- Hero — Dinner, dispatched in minutes.
- How-it-works steps
- Menu (Trending / Comfort / Healthy-ish / Late Night)
- Our story — Dani Okoye
- Gallery strip (gradient + SVG tiles)
- Guest reviews
- Delivery address checker
