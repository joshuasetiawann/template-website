# Black Kettle — BBQ Smokehouse Template

Black Kettle is a smoke-dark BBQ template with a pit schedule, by-the-pound menu, ember-orange accents and a pickup order form.
...
- Layout: **V3 dark moody — full-bleed dark hero, bordered menu columns, masonry gallery and warm accent glow**
...
- Order form (name, email, delivery address) with inline error states and a success message (browser-side only)
...
- Top-of-page scroll-progress hairline in the accent gradient

## Sections

- Hero — Fourteen hours of smoke. Sold by the pound.
- Feature band
- Menu (From the Pit / Plates / Sides / Sweets & Drinks)
- Chef — Otis Crane
