# Switchr Car Subscription — Car Subscription Service Template

A flexible car-subscription template with a swap-anytime vehicle catalogue, monthly-plan compare and subscribe-ready pages.
...
- Daily/weekly/monthly rate comparison
- Form validation on the reserve and contact forms
- Variant V4 design language with a unique palette and typography
