# Pulsemesh — IoT Solutions & Connected Devices Template

Pulsemesh is a modern-gradient, fully multi-page iot solutions & connected devices website template with a services-led primary page, count-up stats, a validated project enquiry form and four complete, interlinked pages.

## Features

- Layout variant: **V3 (modern-gradient)** — pure HTML5 / CSS3 / vanilla JavaScript, no frameworks, fonts, icons or images
...
- `index.html` — homepage: hero with a CSS product mock, services preview, why-us benefits, count-up stats, process steps, case studies & client band, testimonials, tech-stack strip and a contact CTA
...
Change the palette and typography in `:root`, edit the copy in the HTML files, and adjust the `Pulsemesh signature` block at the end of `style.css` for the decorative details.
