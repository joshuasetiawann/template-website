# FixForge — Computer & Device Repair Template

FixForge is a enterprise-solid, fully multi-page computer & device repair website template with a services-led primary page, count-up stats, a validated project enquiry form and four complete, interlinked pages.
...
Change the palette and typography in `:root`, edit the copy in the HTML files, and adjust the `FixForge signature` block at the end of `style.css` for the decorative details.
