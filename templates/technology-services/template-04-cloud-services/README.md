# Stratoshift — Cloud Services & Migration Template

Stratoshift is a modern-gradient, fully multi-page cloud services & migration website template with a services-led primary page, count-up stats, a validated project enquiry form and four complete, interlinked pages.
...
Change the palette and typography in `:root`, edit the copy in the HTML files, and adjust the `Stratoshift signature` block at the end of `style.css` for the decorative details.
