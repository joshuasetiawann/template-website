# Quantleaf — Data Analytics & BI Template

Quantleaf is a modern-gradient, fully multi-page data analytics & bi website template with a services-led primary page, count-up stats, a validated project enquiry form and four complete, interlinked pages.
...
Change the palette and typography in `:root`, edit the copy in the HTML files, and adjust the `Quantleaf signature` block at the end of `style.css` for the decorative details.
