# VertiGrove Farms — Hydroponic Greenhouse Template

A high-tech hydroponic-greenhouse template with a living-greens shop, weekly harvest subscription and a controlled-environment story.

## Features

- Full greens catalogue with a JS category filter, sort and live "Showing N" count
- Subscribe to greens block plus an ordering &amp; pricing section with a sample price list
...
- Variant V4 (modern-agritech) design language with a unique palette, type and sprout motif
...
- index.html — homepage (hero, about teaser, greens preview, practices, gallery, stats, testimonials, CTA)
- products.html — full greens grid with filter chips, weekly harvest box block, ordering &amp; pricing, CTA
...
2. Every navigation item leads to a real, fully built page: Greens, Our farm, Practices, Gallery, Team and Visit.
...
- Greens data lives inline in `products.html`; each card carries `data-cat` and `data-price` for filtering and sorting.
