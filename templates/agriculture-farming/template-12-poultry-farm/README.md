# Sunny Run Poultry — Pastured Poultry Farm Template

A bright, friendly pastured-poultry template with an egg-and-chicken shop, weekly egg subscription and a free-range story.

## Features

- Full poultry catalogue with a JS category filter, sort and live "Showing N" count
- Subscribe to eggs block plus an ordering &amp; pricing section with a sample price list
...
- Variant V5 (wholesome-market) design language with a unique palette, type and egg motif
...
- index.html — homepage (hero, about teaser, poultry preview, practices, gallery, stats, testimonials, CTA)
- products.html — full poultry grid with filter chips, weekly egg delivery block, ordering &amp; pricing, CTA
...
2. Every navigation item leads to a real, fully built page: Poultry, Our farm, Practices, Gallery, Team and Visit.
...
- Poultry data lives inline in `products.html`; each card carries `data-cat` and `data-price` for filtering and sorting.
