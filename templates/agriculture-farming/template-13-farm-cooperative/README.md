# Greenfields Co-op — Farmers' Cooperative Template

A community farm-cooperative template with a multi-farm marketplace, membership info and a story of growers working together.

## Features

- Full marketplace catalogue with a JS category filter, sort and live "Showing N" count
- Become a member block plus an ordering &amp; pricing section with a sample price list
...
- Variant V5 (wholesome-market) design language with a unique palette, type and hands motif
...
- index.html — homepage (hero, about teaser, marketplace preview, practices, gallery, stats, testimonials, CTA)
- products.html — full marketplace grid with filter chips, weekly market box block, ordering &amp; pricing, CTA
...
2. Every navigation item leads to a real, fully built page: Marketplace, Our farm, Practices, Gallery, Team and Visit.
...
- Marketplace data lives inline in `products.html`; each card carries `data-cat` and `data-price` for filtering and sorting.
