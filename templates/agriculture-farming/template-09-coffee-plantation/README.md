# Misty Slopes Estate — Coffee Estate Template

A premium coffee-estate template with a single-origin roast catalogue, subscription and a high-altitude plantation story.

## Features

- Full coffee catalogue with a JS category filter, sort and live "Showing N" count
- Start a coffee subscription block plus an ordering &amp; pricing section with a sample price list
...
- Variant V3 (premium-estate) design language with a unique palette, type and coffee motif
...
- index.html — homepage (hero, about teaser, coffee preview, practices, gallery, stats, testimonials, CTA)
- products.html — full coffee grid with filter chips, fresh-roast delivery block, ordering &amp; pricing, CTA
...
2. Every navigation item leads to a real, fully built page: Coffee, Our farm, Practices, Gallery, Team and Visit.
...
- Coffee data lives inline in `products.html`; each card carries `data-cat` and `data-price` for filtering and sorting.
