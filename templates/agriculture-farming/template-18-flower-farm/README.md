# Petalfield Flowers — Cut-Flower Farm Template

A romantic cut-flower farm template with a seasonal stem shop, bouquet subscription and a field-to-vase story.

## Features

- Full flowers catalogue with a JS category filter, sort and live "Showing N" count
- Subscribe to bouquets block plus an ordering &amp; pricing section with a sample price list
...
- Variant V2 (fresh-organic) design language with a unique palette, type and flower motif
...
- index.html — homepage (hero, about teaser, flowers preview, practices, gallery, stats, testimonials, CTA)
- products.html — full flowers grid with filter chips, weekly flower share block, ordering &amp; pricing, CTA
...
2. Every navigation item leads to a real, fully built page: Flowers, Our farm, Practices, Gallery, Team and Visit.
...
- Flowers data lives inline in `products.html`; each card carries `data-cat` and `data-price` for filtering and sorting.
