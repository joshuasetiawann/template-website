# FieldSignal — AgriTech Platform Template

A modern agritech platform template with a solutions catalog, ROI calculator and a precision-farming product story.

## Features

- Full solutions catalogue with a JS category filter, sort and live "Showing N" count
- Start a free trial block plus an ordering &amp; pricing section with a sample price list
...
- Variant V4 (modern-agritech) design language with a unique palette, type and sensor motif
...
- index.html — homepage (hero, about teaser, solutions preview, practices, gallery, stats, testimonials, CTA)
- products.html — full solutions grid with filter chips, 30-day pilot block, ordering &amp; pricing, CTA
...
2. Every navigation item leads to a real, fully built page: Solutions, Our farm, Practices, Gallery, Team and Visit.
...
- Solutions data lives inline in `products.html`; each card carries `data-cat` and `data-price` for filtering and sorting.
