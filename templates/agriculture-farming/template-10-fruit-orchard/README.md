# Brightboughs Orchard — Fruit Orchard Template

A bright fruit-orchard template with a seasonal fruit stand, pick-your-own info and a blossom-to-harvest orchard story.

## Features

- Full fruit catalogue with a JS category filter, sort and live "Showing N" count
- Pick your own block plus an ordering &amp; pricing section with a sample price list
...
- Variant V2 (fresh-organic) design language with a unique palette, type and apple motif
...
- index.html — homepage (hero, about teaser, fruit preview, practices, gallery, stats, testimonials, CTA)
- products.html — full fruit grid with filter chips, seasonal fruit share block, ordering &amp; pricing, CTA
...
2. Every navigation item leads to a real, fully built page: Fruit, Our farm, Practices, Gallery, Team and Visit.
...
- Fruit data lives inline in `products.html`; each card carries `data-cat` and `data-price` for filtering and sorting.
