/* Iron Ridge Ranch — Livestock Ranch | template-04-livestock-ranch interactions (vanilla JS, dependency-free, file://-safe) */
(function () {
  "use strict";
  document.documentElement.classList.add("js");
  var BRAND = "Iron Ridge Ranch";
  var TEMPLATE = "template-04-livestock-ranch · Livestock Ranch";
  var MOTIF = "cow";
  ...
  /* signature 4: template-04-livestock-ranch · Livestock Ranch */
