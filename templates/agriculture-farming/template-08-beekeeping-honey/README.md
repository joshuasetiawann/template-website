# Goldencomb Apiary — Apiary & Honey Template

A refined apiary template with a raw-honey larder, honey-club subscription and a story rooted in generations of beekeeping.

## Features

- Full honey catalogue with a JS category filter, sort and live "Showing N" count
- Join the honey club block plus an ordering &amp; pricing section with a sample price list
...
- Variant V3 (premium-estate) design language with a unique palette, type and honey motif
...
- index.html — homepage (hero, about teaser, honey preview, practices, gallery, stats, testimonials, CTA)
- products.html — full honey grid with filter chips, seasonal honey crate block, ordering &amp; pricing, CTA
...
2. Every navigation item leads to a real, fully built page: Honey, Our farm, Practices, Gallery, Team and Visit.
...
- Honey data lives inline in `products.html`; each card carries `data-cat` and `data-price` for filtering and sorting.
