# Clearport Brokers — Customs Brokerage Template

Licensed customs brokers who clear your goods fast — duties, compliance and paperwork, handled.
...
- Count-up statistics for entries cleared, coverage and fleet on the home and about pages
...
- Service, team, fleet and FAQ content is plain inline HTML — search the service name (e.g. "Import Clearance") to find and edit it.
