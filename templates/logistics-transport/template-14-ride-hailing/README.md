# HopRide — Ride-Hailing Platform Template

Tap, ride, arrive — a friendly ride-hailing app connecting you with nearby drivers in moments.
...
- Count-up statistics for rides matched, coverage and fleet on the home and about pages
...
- Service, team, fleet and FAQ content is plain inline HTML — search the service name (e.g. "HopRide Standard") to find and edit it.
