# BlueHaul Lines — Container Shipping Line Template

An ocean container line connecting continents — dependable sailings, modern vessels, global reach.
...
- Count-up statistics for TEU shipped, coverage and fleet on the home and about pages
...
- Service, team, fleet and FAQ content is plain inline HTML — search the service name (e.g. "Dry Container (FCL)") to find and edit it.
