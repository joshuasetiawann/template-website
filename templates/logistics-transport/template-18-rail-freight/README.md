# Continental Rail Freight — Rail Freight Haulage Template

Move more for less by rail — high-capacity, low-emission freight trains across the continent.
...
- Count-up statistics for tonnes railed, coverage and fleet on the home and about pages
...
- Service, team, fleet and FAQ content is plain inline HTML — search the service name (e.g. "Intermodal Container") to find and edit it.
