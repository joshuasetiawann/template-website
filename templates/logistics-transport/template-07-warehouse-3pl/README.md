# GridStore 3PL — Warehouse & 3PL Fulfilment Template

Smart warehousing and third-party fulfilment — we store, pick, pack and ship so you can grow.
...
- Count-up statistics for orders fulfilled, coverage and fleet on the home and about pages
...
- Service, team, fleet and FAQ content is plain inline HTML — search the service name (e.g. "Order Fulfilment") to find and edit it.
