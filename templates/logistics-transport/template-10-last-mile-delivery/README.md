# FinalBlock — Last-Mile Delivery Network Template

The last-mile partner for e-commerce — fast, tracked, doorstep delivery your customers will love.
...
- Count-up statistics for orders delivered, coverage and fleet on the home and about pages
...
- Service, team, fleet and FAQ content is plain inline HTML — search the service name (e.g. "Doorstep Delivery") to find and edit it.
