# PulseDispatch — Fleet Dispatch Service Template

Round-the-clock dispatch and fleet coordination — we keep your drivers moving and customers informed.
...
- Count-up statistics for jobs dispatched, coverage and fleet on the home and about pages
...
- Service, team, fleet and FAQ content is plain inline HTML — search the service name (e.g. "Live Dispatch Desk") to find and edit it.
