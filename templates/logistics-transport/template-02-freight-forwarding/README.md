# Meridian Freight — Freight Forwarding Template

Global freight forwarding by sea, air and land — one partner to move your cargo door to door.
...
- Count-up statistics for shipments forwarded, coverage and fleet on the home and about pages
...
- Service, team, fleet and FAQ content is plain inline HTML — search the service name (e.g. "Ocean Freight (FCL)") to find and edit it.
