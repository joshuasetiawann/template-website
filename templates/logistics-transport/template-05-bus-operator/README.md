# RouteRunner — Intercity Bus Operator Template

Comfortable, affordable intercity coaches with Wi-Fi, power and seats you can actually stretch out in.
...
- Count-up statistics for passengers carried, coverage and fleet on the home and about pages
- Validated quote/enquiry form on the contact page with a 24/7 hotline and info cards
- Variant V2 design language (bold-express) with a unique palette, type and motif
...
- Service, team, fleet and FAQ content is plain inline HTML — search the service name (e.g. "Express Intercity") to find and edit it.
