# LockBox Lockers — Parcel Locker Network Template

Collect and send parcels on your schedule — secure smart lockers a short walk from home, open 24/7.
...
- Count-up statistics for parcels collected, coverage and fleet on the home and about pages
- Validated quote/enquiry form on the contact page with a 24/7 hotline and info cards
- Variant V5 design language (friendly-local) with a unique palette, type and motif
...
- Service, team, fleet and FAQ content is plain inline HTML — search the service name (e.g. "Parcel Collection") to find and edit it.
