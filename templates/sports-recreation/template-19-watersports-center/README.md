# Tidewater Watersports Centre — Watersports Centre Template

A multi-page watersports & sailing centre template (V4) with a full programs listing, a JS day-tab weekly schedule, membership tiers and a validated session booking — four complete, interlinked pages.

## Features

- Layout variant: **V4 premium-facility (refined)** — pure HTML5 / CSS3 / vanilla JavaScript, no frameworks, fonts or images
...
- `programs.html` — the primary page: breadcrumb, hero, the full programs listing, a weekly `#schedule` with day-tabs, membership tiers at `#pricing`, a session booking mini-form, an FAQ accordion and a CTA to contact
