# Frostgate Ice Arena — Ice Rink Template

A multi-page ice rink & skating arena template (V5) with a full sessions listing, a JS day-tab weekly schedule, membership tiers and a validated session booking — four complete, interlinked pages.
