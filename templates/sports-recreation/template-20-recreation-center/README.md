# Greenfield Recreation Centre — Recreation Centre Template

A multi-page community recreation centre template (V5) with a full sessions listing, a JS day-tab weekly schedule, membership tiers and a validated session booking — four complete, interlinked pages.
