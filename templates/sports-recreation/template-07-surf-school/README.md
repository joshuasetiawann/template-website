# Saltline Surf School — Surf School Template

A multi-page surf school & coaching template (V3) with a full programs listing, a JS day-tab weekly schedule, membership tiers and a validated session booking — four complete, interlinked pages.

## Features

- Layout variant: **V3 energetic-action (bright, angled)** — pure HTML5 / CSS3 / vanilla JavaScript, no frameworks, fonts or images
