# Blitzfield Paintball — Paintball Arena Template

A multi-page paintball & airsoft arena template (V3) with a full sessions listing, a JS day-tab weekly schedule, membership tiers and a validated session booking — four complete, interlinked pages.
