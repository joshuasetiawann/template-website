# Truenock Archery — Archery Range Template

A multi-page archery range & club template (V2) with a full sessions listing, a JS day-tab weekly schedule, membership tiers and a validated session booking — four complete, interlinked pages.
...
- `index.html` — homepage: energetic hero, club teaser, sessions preview, facilities, coaches preview, membership pricing teaser, upcoming timetable, count-up stats, testimonials and a join CTA
