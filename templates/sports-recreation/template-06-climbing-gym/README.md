# Apex Holds Climbing — Climbing Gym Template

A multi-page indoor climbing & bouldering gym template (V1) with a full sessions listing, a JS day-tab weekly schedule, membership tiers and a validated session booking — four complete, interlinked pages.
