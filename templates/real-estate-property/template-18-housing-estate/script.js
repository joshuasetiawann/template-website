/* Maplewood Park — New-Build Homes for Sale in Reading | property-site interactions (vanilla JS, dependency-free) */
(function () {
  "use strict";

  document.documentElement.classList.add("js");

  var BRAND = "Maplewood Park";
