# Maplewood Park — New Housing Estate Template

Maplewood Park is a new housing estate in Reading offering energy-efficient 2–5 bedroom homes with Help to Buy, an on-site school, village green and superb commuter links. Reserve your plot.
...
- `about.html` — the story, team, process, stats and reviews behind Maplewood Park.
...
---
Part of the multi-page website template library. This is the **template-18-housing-estate** template in the real-estate-property category — a listing-driven property site, distinct from the library's landing-page and company-profile real-estate templates.
