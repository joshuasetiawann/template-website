# Hammerstone Auctions — Property Auction House Template

Hammerstone Auctions runs transparent online property auctions in Manchester with live bidding, legal packs and 28-day completion on residential, commercial and land lots. Watch live lots and bid.
...
- Live auction countdown timers on lot cards and a headline countdown that tick every second
...
- `about.html` — the story, team, process, stats and reviews behind Hammerstone Auctions.
...
---
Part of the multi-page website template library. This is the **template-19-property-auction** template in the real-estate-property category — a listing-driven property site, distinct from the library's landing-page and company-profile real-estate templates.
