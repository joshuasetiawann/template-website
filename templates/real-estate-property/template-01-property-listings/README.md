# Keyline Homes — Property Listings Portal Template

Keyline Homes is a property listings portal with live filtering, mortgage estimates and detailed listings for homes across Seattle.
...
- `about.html` — the story, team, process, stats and reviews behind Keyline Homes.
...
---
Part of the multi-page website template library. This is the **template-01-property-listings** template in the real-estate-property category — a listing-driven property site, distinct from the library's landing-page and company-profile real-estate templates.
