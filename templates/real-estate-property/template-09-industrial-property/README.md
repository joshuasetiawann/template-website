# Irongate Industrial — Industrial & Logistics Property Template

Irongate Industrial leases warehouse, distribution, cold-storage and flex space across the Memphis inland port and logistics parks, with rapid highway, rail and air-cargo access.
...
- `about.html` — the story, team, process, stats and reviews behind Irongate Industrial.
...
---
Part of the multi-page website template library. This is the **template-09-industrial-property** template in the real-estate-property category — a listing-driven property site, distinct from the library's landing-page and company-profile real-estate templates.
