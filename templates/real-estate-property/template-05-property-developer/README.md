# Northgate Developments — Property Developer Masterplan Template

Northgate Developments is delivering a phased riverfront masterplan in Austin with residences, townhomes, penthouses and retail. Explore phases, floor plans and estimate your monthly cost.
...
- Live mortgage / payment calculator (price, deposit %, term, rate -> monthly estimate in US Dollar ($)), repeated on the detail page wired to the selected listing's price
...
## Pages
- `index.html` — the main listing-driven landing page (variant V3).
...
- `about.html` — the story, team, process, stats and reviews behind Northgate Developments.
...
- Calculator defaults (price, deposit, term, rate) are set on the calculator inputs in the HTML; the maths lives in the shared `script.js`.

---
Part of the multi-page website template library. This is the **template-05-property-developer** template in the real-estate-property category — a listing-driven property site, distinct from the library's landing-page and company-profile real-estate templates.
