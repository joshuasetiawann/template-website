# Campus Nest — Student Housing Community Template

Campus Nest offers studios and en-suite student rooms minutes from campus in Manchester, with all bills included, superfast Wi-Fi, gym and a brilliant community.
...
- `about.html` — the story, team, process, stats and reviews behind Campus Nest.
...
---
Part of the multi-page website template library. This is the **template-06-student-housing** template in the real-estate-property category — a listing-driven property site, distinct from the library's landing-page and company-profile real-estate templates.
