# Acorn Tiny Homes — Tiny House Builder Template

Acorn Tiny Homes designs and builds custom tiny houses on wheels and foundation ADUs, delivered nationwide, with off-grid solar options. Explore models and estimate your monthly payment.
...
- `about.html` — the story, team, process, stats and reviews behind Acorn Tiny Homes.
...
---
Part of the multi-page website template library. This is the **template-20-tiny-houses** template in the real-estate-property category — a listing-driven property site, distinct from the library's landing-page and company-profile real-estate templates.
