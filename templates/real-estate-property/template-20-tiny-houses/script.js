/* Acorn Tiny Homes — Custom Tiny Houses, Built & Delivered | property-site interactions (vanilla JS, dependency-free) */
(function () {
  "use strict";

  document.documentElement.classList.add("js");

  var BRAND = "Acorn Tiny Homes";
