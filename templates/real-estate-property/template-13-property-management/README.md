# Anchor Property Group — Property Management Service Template

Anchor Property Group manages multifamily, single-family and HOA communities across Portland with tenant screening, 24/7 maintenance, online rent collection and transparent owner reporting.
...
- `about.html` — the story, team, process, stats and reviews behind Anchor Property Group.
...
---
Part of the multi-page website template library. This is the **template-13-property-management** template in the real-estate-property category — a listing-driven property site, distinct from the library's landing-page and company-profile real-estate templates.
