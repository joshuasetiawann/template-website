# Beacon Mortgages — Mortgage Broker & Adviser Template

Beacon Mortgages is a whole-of-market mortgage broker comparing 90+ lenders for first-time buyers, remortgages, buy-to-let and self-employed clients. Use our calculator and get expert advice.
...
## Pages
- `index.html` — the main listing-driven landing page (variant V1).
...
- `about.html` — the story, team, process, stats and reviews behind Beacon Mortgages.
...
---
Part of the multi-page website template library. This is the **template-14-mortgage-broker** template in the real-estate-property category — a listing-driven property site, distinct from the library's landing-page and company-profile real-estate templates.
