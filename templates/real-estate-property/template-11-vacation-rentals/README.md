# Azulado Stays — Vacation Rental Collection Template

Azulado Stays is a curated collection of beachfront villas, bungalows and sea-view rentals across Mexico's Riviera Maya, with private pools, concierge and instant booking.
...
- `about.html` — the story, team, process, stats and reviews behind Azulado Stays.
...
---
Part of the multi-page website template library. This is the **template-11-vacation-rentals** template in the real-estate-property category — a listing-driven property site, distinct from the library's landing-page and company-profile real-estate templates.
