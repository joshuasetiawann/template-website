# Hannah Ford Realty — Real Estate Agent Profile Template

Hannah Ford is a five-star real estate agent helping families buy and sell homes across Chapel Hill, Durham and the North Carolina Triangle with warmth and local expertise.
...
- `about.html` — the story, team, process, stats and reviews behind Hannah Ford Realty.
...
---
Part of the multi-page website template library. This is the **template-04-real-estate-agent** template in the real-estate-property category — a listing-driven property site, distinct from the library's landing-page and company-profile real-estate templates.
