# Meridian Workspace — Commercial Office Leasing Template

Meridian Workspace leases premium office floors and suites across Chicago's Loop, River North and West Loop. Explore floor plates, amenities and estimate your monthly occupancy cost.
...
## Pages
- `index.html` — the main listing-driven landing page (variant V5).
...
- `about.html` — the story, team, process, stats and reviews behind Meridian Workspace.
...
---
Part of the multi-page website template library. This is the **template-08-commercial-office** template in the real-estate-property category — a listing-driven property site, distinct from the library's landing-page and company-profile real-estate templates.
