# Commonhouse — Co-living Members' Community Template

Commonhouse offers beautifully designed co-living rooms and studios in London with bills, cleaning and a built-in community included. Flexible monthly stays, move in this week.
...
- `about.html` — the story, team, process, stats and reviews behind Commonhouse.
...
---
Part of the multi-page website template library. This is the **template-07-coliving-space** template in the real-estate-property category — a listing-driven property site, distinct from the library's landing-page and company-profile real-estate templates.
