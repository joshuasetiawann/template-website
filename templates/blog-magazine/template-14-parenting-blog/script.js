/* ==========================================================================
   Little Wonders — Parenting Blog · script.js
   Template: template-14-parenting-blog (variant v1)
...
(function () {
  ...
  var SITE = { slug: 'template-14-parenting-blog', brand: 'Little Wonders', noun: 'notes', listen: false };
  ...
  if (newsForm) {
    ...
    newsForm.addEventListener('submit', function (e) {
      ...
      if (!value) {
        ...
        formMsg.textContent = 'Welcome to the fridge-door list — first note this Sunday.';
