/* ==========================================================================
   Butter & Thyme — Recipe Blog · script.js
   Template: template-05-recipe-blog (variant v1)
...
(function () {
  ...
  var SITE = { slug: 'template-05-recipe-blog', brand: 'Butter & Thyme', noun: 'recipes', listen: false };
  ...
  if (newsForm) {
    ...
    newsForm.addEventListener('submit', function (e) {
      ...
      if (!value) {
        ...
        formMsg.textContent = 'You\'re in! Thursday\'s menu letter is preheating.';
