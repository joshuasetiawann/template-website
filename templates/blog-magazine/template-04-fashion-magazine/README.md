# Lumière — Fashion Magazine Template

Lumière is a multi-page fashion magazine template built as a bold magazine (full-bleed cover hero, asymmetric mosaic grid, oversized pull-quote band), with a full home page and a matching article reading view.
...
- **Masthead / navigation** — brand mark plus jump links: Stories, The list, Dispatch, Masthead
...
- **About the editor** — a short blurb introducing Odette Marchand
- **Newsletter** — an email sign-up with inline validation messages
- **Footer** — brand summary, quick links, topics (Runway, Editorials, Beauty, Street Style, Interviews) and social icons
...
- **Colors & type** — every theme value lives in the `:root` custom properties at the top of `style.css` (accent is `#141210`). Change them once to retheme both pages.
