/* ==========================================================================
   Lumière — Fashion Magazine · script.js
   Template: template-04-fashion-magazine (variant v4)
...
(function () {
  ...
  var SITE = { slug: 'template-04-fashion-magazine', brand: 'Lumière', noun: 'stories', listen: false };
  ...
  if (newsForm) {
    ...
    newsForm.addEventListener('submit', function (e) {
      ...
      if (!value) {
        ...
        formMsg.textContent = 'Welcome to The Dispatch — Sunday, golden hour, your inbox.';
