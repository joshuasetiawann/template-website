/* ==========================================================================
   Basis Point — Finance Blog · script.js
   Template: template-17-finance-blog (variant v1)
...
(function () {
  ...
  var SITE = { slug: 'template-17-finance-blog', brand: 'Basis Point', noun: 'notes', listen: false };
  ...
  if (newsForm) {
    ...
    newsForm.addEventListener('submit', function (e) {
      ...
      if (!value) {
        ...
        formMsg.textContent = 'Allocated — the Monday Memo compounds in your inbox weekly.';
