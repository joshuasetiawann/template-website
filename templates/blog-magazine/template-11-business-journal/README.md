# The Ledger Standard — Business Journal Template

The Ledger Standard is a multi-page business journal template built as a news portal (breaking-news ticker, dense multi-section front page, compact story lists), with a full home page and a matching article reading view.
...
- Lead/hero post, a filterable grid of columns, a numbered trending list and a newsletter sign-up
...
- **Masthead / navigation** — brand mark plus jump links: The edition, Markets, Companies, Most read, The Bell
- **Hero** — the featured column with category, byline, read time and calls to action
...
- **About the editor** — a short blurb introducing Edmund Carey
- **Newsletter** — an email sign-up with inline validation messages
- **Footer** — brand summary, quick links, topics (Markets, Companies, Economy, Deals, Opinion) and social icons
...
- **Colors & type** — every theme value lives in the `:root` custom properties at the top of `style.css` (accent is `#B08D57`). Change them once to retheme both pages.
