/* ==========================================================================
   The Ledger Standard — Business Journal · script.js
   Template: template-11-business-journal (variant v2)
...
(function () {
  ...
  var SITE = { slug: 'template-11-business-journal', brand: 'The Ledger Standard', noun: 'columns', listen: false };
  ...
  if (newsForm) {
    ...
    newsForm.addEventListener('submit', function (e) {
      ...
      if (!value) {
        ...
        formMsg.textContent = 'Confirmed — The Opening Bell rings in your inbox at 7:00 sharp.';
  ...
  /* --- Edition clock in the header (variant V2) --- */
  ...
  if (clock) {
    var tickClock = function () {
      ...
      clock.textContent = days[now.getDay()] + ' edition - ' + hh + ':' + mm;
    };
    tickClock();
