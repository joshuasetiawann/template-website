# Aperture Null — Photography Zine Template

Aperture Null is a multi-page photography zine template built as a bold magazine (full-bleed cover hero, asymmetric mosaic grid, oversized pull-quote band), with a full home page and a matching article reading view.
...
- Lead/hero post, a filterable grid of plates, a numbered trending list and a newsletter sign-up
...
- **Masthead / navigation** — brand mark plus jump links: Plates, Contact sheet, Darkroom, Subscribe
- **Hero** — the featured plate with category, byline, read time and calls to action
...
- **About the editor** — a short blurb introducing Daria Holt
- **Newsletter** — an email sign-up with inline validation messages
- **Footer** — brand summary, quick links, topics (Series, Process, Gear Notes, Darkroom, Interviews) and social icons
...
- **Colors & type** — every theme value lives in the `:root` custom properties at the top of `style.css` (accent is `#F5F5F2`). Change them once to retheme both pages.
