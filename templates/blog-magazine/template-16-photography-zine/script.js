/* ==========================================================================
   Aperture Null — Photography Zine · script.js
   Template: template-16-photography-zine (variant v4)
...
(function () {
  ...
  var SITE = { slug: 'template-16-photography-zine', brand: 'Aperture Null', noun: 'plates', listen: false };
  ...
  if (newsForm) {
    ...
    newsForm.addEventListener('submit', function (e) {
      ...
      if (!value) {
        ...
        formMsg.textContent = 'Fixed and washed — issue 10 arrives with the new moon.';
