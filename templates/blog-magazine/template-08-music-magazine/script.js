/* ==========================================================================
   Frequency — Music Magazine · script.js
   Template: template-08-music-magazine (variant v5)
...
(function () {
  ...
  var SITE = { slug: 'template-08-music-magazine', brand: 'Frequency', noun: 'stories', listen: false };
  ...
  if (newsForm) {
    ...
    newsForm.addEventListener('submit', function (e) {
      ...
      if (!value) {
        ...
        formMsg.textContent = 'On the list — The B-Side spins into your inbox Friday.';
