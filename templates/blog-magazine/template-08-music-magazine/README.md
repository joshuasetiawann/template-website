# Frequency — Music Magazine Template

Frequency is a multi-page music magazine template built as a dark zine (dark theme, shelf/masonry layout, duotone covers, topic marquee), with a full home page and a matching article reading view.
...
- **Masthead / navigation** — brand mark plus jump links: Reviews, Rotation, The B-Side, About
...
- **About the editor** — a short blurb introducing Nova Reyes
- **Newsletter** — an email sign-up with inline validation messages
- **Footer** — brand summary, quick links, topics (Album Reviews, Scene Reports, Gear, Interviews, Playlists) and social icons
...
- **Colors & type** — every theme value lives in the `:root` custom properties at the top of `style.css` (accent is `#A855F7`). Change them once to retheme both pages.
