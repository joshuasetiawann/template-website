/* ==========================================================================
   Stackline — Tech Blog · script.js
   Template: template-02-tech-blog (variant v1)
...
(function () {
  ...
  var SITE = { slug: 'template-02-tech-blog', brand: 'Stackline', noun: 'posts', listen: false };
  ...
  if (newsForm) {
    ...
    newsForm.addEventListener('submit', function (e) {
      ...
      if (!value) {
        ...
        formMsg.textContent = 'Subscribed — issue #143 lands in your inbox Thursday.';
