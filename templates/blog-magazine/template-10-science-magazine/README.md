# Orbital — Science Magazine Template

Orbital is a multi-page science magazine template built as a classic editorial (split featured hero, three-column grid with a sticky right sidebar), with a full home page and a matching article reading view.
...
- **Masthead / navigation** — brand mark plus jump links: Research, Field notes, Masthead, Briefing
...
- **About the editor** — a short blurb introducing Dr. Amara Osei
- **Newsletter** — an email sign-up with inline validation messages
- **Footer** — brand summary, quick links, topics (Space, Biology, Physics, Climate, Minds) and social icons
...
- **Colors & type** — every theme value lives in the `:root` custom properties at the top of `style.css` (accent is `#1E40AF`). Change them once to retheme both pages.
