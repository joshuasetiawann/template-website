/* ==========================================================================
   Orbital — Science Magazine · script.js
   Template: template-10-science-magazine (variant v1)
...
(function () {
  ...
  var SITE = { slug: 'template-10-science-magazine', brand: 'Orbital', noun: 'stories', listen: false };
  ...
  if (newsForm) {
    ...
    newsForm.addEventListener('submit', function (e) {
      ...
      if (!value) {
        ...
        formMsg.textContent = 'Confirmed — Orbit Notes arrives every other Tuesday.';
