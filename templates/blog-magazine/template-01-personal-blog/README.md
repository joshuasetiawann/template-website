# Inkwell & Ash — Personal Blog Template

Inkwell & Ash is a multi-page personal blog template built as a minimal essay (centered reading column, large serif, list-style index, reading-progress bar), with a full home page and a matching article reading view.
...
- **Masthead / navigation** — brand mark plus jump links: Essays, Most loved, About, The letter
...
- **About the editor** — a short blurb introducing June Calloway
- **Newsletter** — an email sign-up with inline validation messages
- **Footer** — brand summary, quick links, topics (Essays, Letters, City Notes, Slow Living, Reading Life) and social icons
...
- **Colors & type** — every theme value lives in the `:root` custom properties at the top of `style.css` (accent is `#C2613E`). Change them once to retheme both pages.
