/* ==========================================================================
   Inkwell & Ash — Personal Blog · script.js
   Template: template-01-personal-blog (variant v3)
...
(function () {
  ...
  var SITE = { slug: 'template-01-personal-blog', brand: 'Inkwell & Ash', noun: 'essays', listen: false };
  ...
  if (newsForm) {
    ...
    newsForm.addEventListener('submit', function (e) {
      ...
      if (!value) {
        ...
        formMsg.textContent = 'Lovely — your first Sunday letter is on its way.';
