/* ==========================================================================
   Stillpoint — Health & Wellness Blog · script.js
   Template: template-18-health-wellness-blog (variant v3)
...
(function () {
  ...
  var SITE = { slug: 'template-18-health-wellness-blog', brand: 'Stillpoint', noun: 'essays', listen: false };
  ...
  if (newsForm) {
    ...
    newsForm.addEventListener('submit', function (e) {
      ...
      if (!value) {
        ...
        formMsg.textContent = 'Welcome — breathe out, your first Sunday Stretch is on its way.';
