/* ==========================================================================
   The Daily Meridian — News Portal · script.js
   Template: template-03-news-portal (variant v2)
...
(function () {
  ...
  var SITE = { slug: 'template-03-news-portal', brand: 'The Daily Meridian', noun: 'stories', listen: false };
  ...
  if (newsForm) {
    ...
    newsForm.addEventListener('submit', function (e) {
      ...
      if (!value) {
        ...
        formMsg.textContent = 'Done — The Morning Brief arrives tomorrow at 6:00.';
