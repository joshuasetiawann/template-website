# The Daily Meridian — News Portal Template

The Daily Meridian is a multi-page news portal template built as a news portal (breaking-news ticker, dense multi-section front page, compact story lists), with a full home page and a matching article reading view.
...
- **Masthead / navigation** — brand mark plus jump links: Latest, World, Politics, Most read, Brief
...
- **About the editor** — a short blurb introducing Saul Whitfield
- **Newsletter** — an email sign-up with inline validation messages
- **Footer** — brand summary, quick links, topics (World, Politics, Economy, Climate, Culture) and social icons
...
- **Colors & type** — every theme value lives in the `:root` custom properties at the top of `style.css` (accent is `#C0212E`). Change them once to retheme both pages.
