/* ==========================================================================
   TILT — Art & Culture Magazine · script.js
   Template: template-19-art-culture-magazine (variant v4)
...
(function () {
  ...
  var SITE = { slug: 'template-19-art-culture-magazine', brand: 'TILT', noun: 'features', listen: false };
  ...
  if (newsForm) {
    ...
    newsForm.addEventListener('submit', function (e) {
      ...
      if (!value) {
        ...
        formMsg.textContent = 'Hung! The Crooked Letter arrives Thursday, slightly rotated.';
