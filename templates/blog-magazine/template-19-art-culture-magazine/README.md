# TILT — Art & Culture Magazine Template

TILT is a multi-page art & culture magazine template built as a bold magazine (full-bleed cover hero, asymmetric mosaic grid, oversized pull-quote band), with a full home page and a matching article reading view.
...
- Lead/hero post, a filterable grid of features, a numbered trending list and a newsletter sign-up
...
- **Masthead / navigation** — brand mark plus jump links: Features, Most read, The Letter, About
- **Hero** — the featured feature with category, byline, read time and calls to action
...
- **About the editor** — a short blurb introducing Niko Faber
- **Newsletter** — an email sign-up with inline validation messages
- **Footer** — brand summary, quick links, topics (Exhibitions, Studio Visits, Film & Stage, Design, Public Art) and social icons
...
- **Colors & type** — every theme value lives in the `:root` custom properties at the top of `style.css` (accent is `#2B4CFF`). Change them once to retheme both pages.
