/* ==========================================================================
   Respawn Point — Gaming Blog · script.js
   Template: template-13-gaming-blog (variant v5)
...
(function () {
  ...
  var SITE = { slug: 'template-13-gaming-blog', brand: 'Respawn Point', noun: 'articles', listen: false };
  ...
  if (newsForm) {
    ...
    newsForm.addEventListener('submit', function (e) {
      ...
      if (!value) {
        ...
        formMsg.textContent = 'Checkpoint reached — first issue spawns Thursday.';
