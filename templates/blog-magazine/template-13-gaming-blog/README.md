# Respawn Point — Gaming Blog Template

Respawn Point is a multi-page gaming blog template built as a dark zine (dark theme, shelf/masonry layout, duotone covers, topic marquee), with a full home page and a matching article reading view.
...
- Lead/hero post, a filterable grid of articles, a numbered trending list and a newsletter sign-up
...
- **Masthead / navigation** — brand mark plus jump links: Articles, Leaderboard, Checkpoint, Party
- **Hero** — the featured article with category, byline, read time and calls to action
...
- **About the editor** — a short blurb introducing Kit Harlow
- **Newsletter** — an email sign-up with inline validation messages
- **Footer** — brand summary, quick links, topics (Reviews, Indie, Esports, Hardware, Patch Notes) and social icons
...
- **Colors & type** — every theme value lives in the `:root` custom properties at the top of `style.css` (accent is `#22E584`). Change them once to retheme both pages.
