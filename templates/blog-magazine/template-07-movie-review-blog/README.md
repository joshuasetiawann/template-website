# Grindhouse Weekly — Movie Review Blog Template

Grindhouse Weekly is a multi-page movie review blog template built as a dark zine (dark theme, shelf/masonry layout, duotone covers, topic marquee), with a full home page and a matching article reading view.
...
- Star-rated verdict block with pros and cons, author bio, prev/next pager and three related cards on every article
...
- **Masthead / navigation** — brand mark plus jump links: Now showing, Reviews, Most read, The Reel
...
- **About the editor** — a short blurb introducing Cass Delgado
- **Newsletter** — an email sign-up with inline validation messages
- **Footer** — brand summary, quick links, topics (Reviews, Retrospectives, Festivals, Streaming, Interviews) and social icons
...
- **Colors & type** — every theme value lives in the `:root` custom properties at the top of `style.css` (accent is `#F5C518`). Change them once to retheme both pages.
