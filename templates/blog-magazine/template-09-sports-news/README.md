# Full Press — Sports News Template

Full Press is a multi-page sports news template built as a news portal (breaking-news ticker, dense multi-section front page, compact story lists), with a full home page and a matching article reading view.
...
- **Masthead / navigation** — brand mark plus jump links: Latest, Match centre, Transfers, Most read, Briefing
...
- **About the editor** — a short blurb introducing Renata Diaz
- **Newsletter** — an email sign-up with inline validation messages
- **Footer** — brand summary, quick links, topics (Football, Basketball, Tennis, Athletics, Analysis) and social icons
...
- **Colors & type** — every theme value lives in the `:root` custom properties at the top of `style.css` (accent is `#15803D`). Change them once to retheme both pages.
