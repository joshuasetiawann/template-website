/* ==========================================================================
   The Wanderlog — Travel Journal · script.js
   Template: template-06-travel-journal (variant v3)
...
(function () {
  ...
  var SITE = { slug: 'template-06-travel-journal', brand: 'The Wanderlog', noun: 'dispatches', listen: false };
  ...
  if (newsForm) {
    ...
    newsForm.addEventListener('submit', function (e) {
      ...
      if (!value) {
        ...
        formMsg.textContent = 'Stamped and sorted — your first letter leaves with the next post.';
