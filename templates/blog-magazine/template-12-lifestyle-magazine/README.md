# Golden Hour — Lifestyle Magazine Template

Golden Hour is a multi-page lifestyle magazine template built as a bold magazine (full-bleed cover hero, asymmetric mosaic grid, oversized pull-quote band), with a full home page and a matching article reading view.
...
- Lead/hero post, a filterable grid of stories, a numbered trending list and a newsletter sign-up
...
- **Masthead / navigation** — brand mark plus jump links: Stories, Favorites, The Slow, About
- **Hero** — the featured storie with category, byline, read time and calls to action
...
- **About the editor** — a short blurb introducing Romy Castellano
- **Newsletter** — an email sign-up with inline validation messages
- **Footer** — brand summary, quick links, topics (Home, Wellbeing, Style, Entertaining, City Guides) and social icons
...
- **Colors & type** — every theme value lives in the `:root` custom properties at the top of `style.css` (accent is `#C26D4B`). Change them once to retheme both pages.
