/* ==========================================================================
   Golden Hour — Lifestyle Magazine · script.js
   Template: template-12-lifestyle-magazine (variant v4)
...
(function () {
  ...
  var SITE = { slug: 'template-12-lifestyle-magazine', brand: 'Golden Hour', noun: 'stories', listen: false };
  ...
  if (newsForm) {
    ...
    newsForm.addEventListener('submit', function (e) {
      ...
      if (!value) {
        ...
        formMsg.textContent = 'Welcome in — your first Sunday Slow arrives this weekend.';
