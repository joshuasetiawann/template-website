# Verdant Grid Energy — Solar, Wind & Storage Development Company Profile Template

Verdant Grid Energy is a deep-green renewable energy profile template with lime-and-sky accents, curved section breaks and audited impact case studies.
...
- `index.html` — the one-page developer profile (hero, about, services, why-us, results, team, certifications, contact form)
- `services.html` — capabilities in depth: each development service as an anchored block with what's included and process, plus a CTA back to contact
