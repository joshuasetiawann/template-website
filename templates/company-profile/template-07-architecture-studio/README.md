# Atelier Northgrid — Architecture & Spatial Design Company Profile Template

Atelier Northgrid is an ultra-minimal architecture studio profile template with huge numerals, hairline grids and an accordion of disciplines.
...
- `index.html` — the single-page studio profile: hero, statement of intent, disciplines accordion, principles, method, built work grid, team and contact
- `services.html` — "Disciplines in Depth": each discipline as a sheet with fee, deliverables and method (`#svc-1`…`#svc-6`), three built case studies recorded with programme, budget and completion (`#case-1`–`#case-3`), a commissioning FAQ and a closing CTA back to the contact form
...
The homepage work grid deep-links into those records; placeholder social links (team rows and footer) carry `data-demo-link` and never navigate.
