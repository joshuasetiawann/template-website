/* ==========================================================
   MeridianHaul Logistics — Freight, Warehousing & Last-Mile
   Template: template-05-logistics-company (V1 corporate classic)
...
/* ---- v2 add-on: services depth page wiring (runs safely on both pages) ---- */
(function () {
  'use strict';

  /* inert demo placeholders: any [data-demo-link] click is swallowed */
  document.addEventListener('click', function (e) {
    var demo = e.target && e.target.closest ? e.target.closest('[data-demo-link]') : null;
    if (demo) { e.preventDefault(); }
  });

  /* services-page FAQ accordion (.svq) — this template has no other accordion */
  ...
  svqBtns.forEach(function (btn) {
    btn.addEventListener('click', function () {
      ...
      var panel = ctl ? document.getElementById(ctl) : null;
