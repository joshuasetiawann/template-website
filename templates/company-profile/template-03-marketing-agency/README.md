# Studio Vermilion — Brand & Performance Marketing Company Profile Template

Studio Vermilion is a Swiss-minimal marketing agency profile template with huge typography, accordion services and a hairline work grid.
...
- `index.html` — the one-page profile: hero, manifesto, capabilities accordion, principles, selected-work grid, team, quotes and contact
- `services.html` — services &amp; case-studies depth page: every capability unfolded (`#svc-1`…`#svc-6` with deliverables, three-step process and starting fees), three case studies (`#case-1`–`#case-3`), a buying FAQ and a CTA back to the contact form
...
Work-grid cells on the homepage deep-link into these blocks; demo placeholder links (team and footer socials) carry `data-demo-link` and stay inert.
