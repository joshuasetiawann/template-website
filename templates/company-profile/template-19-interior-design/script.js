/* ==========================================================
   Maison Ochre & Fen — Interior Design Studio
   Template: template-19-interior-design (V3 Swiss minimal)
...
/* ---- v2: Services & Projects page — placeholder-link guard (shared, null-safe) ---- */
(function () {
  'use strict';
  /* The studio mini-socials and footer icons are demo placeholders carrying
     data-demo-link; intercept the click so the page does not jump. The
     services-page FAQ reuses the existing .acc markup, so the .acc-btn handler
     defined earlier already drives it — no extra accordion logic belongs here. */
  document.addEventListener('click', function (evt) {
    var ph = evt.target && evt.target.closest ? evt.target.closest('[data-demo-link]') : null;
    if (ph) { evt.preventDefault(); }
  });
})();
