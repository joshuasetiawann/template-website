/* ==========================================================
   Nexcore Systems — Cloud & Software Engineering
   Template: template-01-tech-company (V1 corporate classic)
...
/* ---- v2: services page + demo-link guard (shared across pages) ---- */
(function () {
  'use strict';

  /* placeholder links (team & footer socials) marked data-demo-link stay inert */
  document.addEventListener('click', function (e) {
    var demo = e.target && e.target.closest ? e.target.closest('[data-demo-link]') : null;
    if (demo) { e.preventDefault(); }
  });
  /* accordion + count-up on services.html reuse the handlers above (.acc-btn / .count) */
})();
