/* ==========================================================
   Solana Voyages — Boutique Travel & Tours
   Template: template-14-travel-company (V2 modern overlay)
...
/* ---- v2: Trips & Stories page support (runs safely on both pages) ---- */
(function () {
  'use strict';
  /* Placeholder links (social icons, footer) carry data-demo-link — keep them inert.
     The services FAQ reuses the existing .acc markup, so the .acc-btn handler above
     already drives it; no second accordion is bound here. */
