/* ==========================================================
   Aldergate Advisory — Independent Financial Consulting
   Template: template-06-finance-consultant (V5 warm local)
   Vanilla JS: mobile nav, validated contact form, accordion, testimonial slider
   ========================================================== */
(function () {
  'use strict';
...
/* ---- v2: services depth page — shared placeholder-link guard ---- */
(function () {
  'use strict';
  /* Team and footer social icons are demo placeholders (href="#") marked with
     data-demo-link; swallow the click so the page never jumps back to the top.
     The services-page FAQ reuses the .acc markup above, so no new accordion
     code is needed here — the existing handler drives both pages. */
