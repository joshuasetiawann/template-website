# Aldergate Advisory — Independent Financial Consulting Company Profile Template

Aldergate Advisory is a warm, trust-led financial consulting profile template with fee-transparent service cards, testimonials and credential badges.
...
- `index.html` — the one-page profile (hero, story, services, why-us, credentials, testimonials, team, gallery, FAQ, contact)
- `services.html` — "Plans & Outcomes" depth page: each service opened up with deliverables, a three-step process and its flat fee (`#svc-1`…`#svc-6`), three anonymized client outcome stories (`#case-1`–`#case-3`), a buying FAQ and a CTA back to the contact form
...
- Three gallery tiles on the homepage link to the client stories and three to their service blocks; demo placeholder links (team and footer socials) carry `data-demo-link` and stay inert
