# IronRidge Constructions — Commercial Construction & Civil Works Company Profile Template

IronRidge Constructions is a bold construction company profile template with tabbed services, a filterable project grid and hazard-stripe styling.
...
- `index.html` — the full one-page profile: hero, about, tabbed services, certifications, why-us, filterable project grid, team, owner references, CTA strip and contact form
- `services.html` — capabilities & case-files depth page: six anchored service blocks (`#svc-1`…`#svc-6`) with deliverables, a three-step sequence and budget hints, three completed-job case files (`#case-1`–`#case-3`) carrying schedule and safety numbers, an owner FAQ and a CTA back to `index.html#contact`
...
- Demo placeholder links (team mini-socials and footer social icons) carry `data-demo-link` and never navigate
