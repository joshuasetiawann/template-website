/* ==========================================================
   Alder Gate College — Independent College & Sixth Form
   Template: template-09-education-institution (V2 modern overlay)
   Vanilla JS: mobile nav, validated contact form, count-up stats, service tabs, portfolio filter
   ========================================================== */
(function () {
  'use strict';
