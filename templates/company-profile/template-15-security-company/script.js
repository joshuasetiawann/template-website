/* ==========================================================
   Sentinel Axis — Cybersecurity & Risk Operations
   Template: template-15-security-company (V4 dark premium)
...
/* ---- v2 // mission-files rollout: demo-link interception (all pages) ---- */
(function () {
  'use strict';
  /* Links flagged data-demo-link are decoys by design — intercept the click
     before the browser follows it anywhere. */
