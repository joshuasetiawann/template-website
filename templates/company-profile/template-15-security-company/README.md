# Sentinel Axis — Cybersecurity & Risk Operations Company Profile Template

Sentinel Axis is a midnight-and-cyan security company profile template with radar grid styling, a SOC capability bento and engagement-protocol timeline.
...
- `index.html` — the one-page profile: hero with KPI band, about, operations bento, engagement protocol, onboarding runbook, mission log, FAQ, team, certifications and contact form
- `services.html` — the mission-files depth page: six ops briefs (`#svc-1`…`#svc-6`) with retainer pricing, three declassified case debriefs (`#case-1`–`#case-3`) matching the homepage mission log, a procurement FAQ and a CTA back to the contact form
...
- Demo placeholder links (team and footer socials) are flagged with `data-demo-link` and never navigate away
