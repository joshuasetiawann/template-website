/* ==========================================================
   Casa Fiorelli Group — Family Restaurant Group
   Template: template-11-restaurant-group (V5 warm local)
...
/* ---- v2: tables & stories page — svq accordion + demo-link stopper ---- */
(function () {
  'use strict';
  /* social icons are placeholders (href="#" + data-demo-link); eat the click */
  document.addEventListener('click', function (ev) {
    var hit = ev.target && ev.target.closest ? ev.target.closest('[data-demo-link]') : null;
    if (hit) { ev.preventDefault(); }
  });
  /* the services-page FAQ uses its own .svq accordion — bind it here, null-safe */
