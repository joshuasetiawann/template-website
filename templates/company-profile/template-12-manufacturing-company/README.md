# Vulkan Precision Works — Precision Manufacturing & Fabrication Company Profile Template

Vulkan Precision Works is a graphite-and-amber manufacturing profile template with blueprint grid styling, a bento capability matrix and tolerance-grade case studies.

## Features

- Layout variant: **V4 dark premium** — pure HTML5 / CSS3 / vanilla JavaScript
...
- `index.html` — the single-page profile: hero with KPI band, about, capability matrix, process timeline, case files, team, certifications, CTA strip and contact form
- `services.html` — the capability-files depth page: six traveler-style capability blocks (`#svc-1`…`#svc-6`) with per-part pricing hints, three expanded case files (`#case-1`–`#case-3`) matching the homepage cards, an RFQ FAQ accordion and a CTA back to the contact form
...
- Placeholder demo links (team and footer social icons) carry `data-demo-link` so clicks stay on the page

## Sections

1. Sticky navbar with mobile toggle
1. Hero (V4 dark premium layout)
1. About / story
1. Services
1. Process timeline
1. Why choose us
