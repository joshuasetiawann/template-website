/* ==========================================================
   Vulkan Precision Works — Precision Manufacturing & Fabrication
   Template: template-12-manufacturing-company (V4 dark premium)
...
/* ==========================================================
   v2 — capability-files page additions (runs on both pages)
   Demo-link stop + RFQ accordion (.svq); everything null-safe
   ========================================================== */
(function () {
  'use strict';

  /* demo placeholders: marked links stay parked instead of jumping */
  document.addEventListener('click', function (e) {
    var demo = e.target && e.target.closest ? e.target.closest('[data-demo-link]') : null;
    if (demo) { e.preventDefault(); }
  });

  /* RFQ-desk accordion: .svq-btn toggles its aria-controls panel */
