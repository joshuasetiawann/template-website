/* ==========================================================
   Velvet Comet Events — Event Production & Experiences
   Template: template-17-event-organizer (V5 warm local)
   Vanilla JS: mobile nav, validated contact form, count-up stats, accordion, testimonial slider
   ========================================================== */
(function () {
  'use strict';
