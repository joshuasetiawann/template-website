# Hartwell & Crane LLP — Corporate & Disputes Law Firm Company Profile Template

Hartwell and Crane LLP is a dark, gold-accented law firm profile template with a KPI band, bento practice areas and case results with metrics.
...
- `index.html` — the one-page profile: hero with KPI band, rankings, about, practice areas, team, recent results, FAQ and the contact form
- `services.html` — practice depth & matter briefs: six practice blocks (`#svc-1`…`#svc-6`), three matter briefs (`#case-1`–`#case-3`) matching the homepage result cards, an engagement FAQ and a CTA back to the contact form
...
- Demo placeholder links (team and footer social icons) carry `data-demo-link` and stay on the page instead of navigating
