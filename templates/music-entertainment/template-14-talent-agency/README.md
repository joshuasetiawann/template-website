# Lantern Talent — Talent Agency Template

Lantern Talent is a full multi-page talent agency website template in the "editorial artist" style (V5), with a fake audio player, a filterable roster dates listing and four complete, interlinked pages.
...
- A full roster dates listing with date, venue, city and sold-out / few-left status badges, narrowed by a city and month filter
...
- `index.html` — homepage: hero, about teaser, a listen section with the fake audio player and roster dates / releases, an upcoming-events preview, a media strip, press testimonials with stars and a validated newsletter
