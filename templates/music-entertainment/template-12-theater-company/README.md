# The Saltbridge Players — Theater Company Template

The Saltbridge Players is a full multi-page theater company website template in the "elegant classical" style (V3), with a fake audio player, a filterable the season listing and four complete, interlinked pages.
...
- A full the season listing with date, venue, city and sold-out / few-left status badges, narrowed by a city and month filter
...
- `index.html` — homepage: hero, about teaser, a listen section with the fake audio player and the season / releases, an upcoming-events preview, a media strip, press testimonials with stars and a validated newsletter
