# Cassia Vale — Solo Musician Template

Cassia Vale is a full multi-page solo musician website template in the "editorial artist" style (V5), with a fake audio player, a filterable live shows listing and four complete, interlinked pages.
...
- A full live shows listing with date, venue, city and sold-out / few-left status badges, narrowed by a city and month filter
...
- `index.html` — homepage: hero, about teaser, a listen section with the fake audio player and live shows / releases, an upcoming-events preview, a media strip, press testimonials with stars and a validated newsletter
