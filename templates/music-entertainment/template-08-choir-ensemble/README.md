# The Aurelian Choir — Choir & Vocal Ensemble Template

The Aurelian Choir is a full multi-page choir & vocal ensemble website template in the "elegant classical" style (V3), with a fake audio player, a filterable concert season listing and four complete, interlinked pages.

## Features

- Layout variant: **V3 (elegant classical)** — pure HTML5 / CSS3 / vanilla JavaScript, with no frameworks, fonts or images loaded from anywhere
...
- A full concert season listing with date, venue, city and sold-out / few-left status badges, narrowed by a city and month filter
...
- `index.html` — homepage: hero, about teaser, a listen section with the fake audio player and concert season / releases, an upcoming-events preview, a media strip, press testimonials with stars and a validated newsletter
