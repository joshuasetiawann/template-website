# NOVA SAGE — DJ / Electronic Artist Template

NOVA SAGE is a full multi-page dj / electronic artist website template in the "dark stage" style (V1), with a fake audio player, a filterable show dates listing and four complete, interlinked pages.

## Features

- Layout variant: **V1 (dark stage)** — pure HTML5 / CSS3 / vanilla JavaScript, with no frameworks, fonts or images loaded from anywhere
...
- A full show dates listing with date, venue, city and sold-out / few-left status badges, narrowed by a city and month filter
...
- `index.html` — homepage: hero, about teaser, a listen section with the fake audio player and show dates / releases, an upcoming-events preview, a media strip, press testimonials with stars and a validated newsletter
