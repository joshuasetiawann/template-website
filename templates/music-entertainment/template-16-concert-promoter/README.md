# Highrise Live — Concert Promoter Template

Highrise Live is a full multi-page concert promoter website template in the "editorial artist" style (V5), with a fake audio player, a filterable upcoming shows listing and four complete, interlinked pages.

## Features

- Layout variant: **V5 (editorial artist)** — pure HTML5 / CSS3 / vanilla JavaScript, with no frameworks, fonts or images loaded from anywhere
...
- A full upcoming shows listing with date, venue, city and sold-out / few-left status badges, narrowed by a city and month filter
...
- `index.html` — homepage: hero, about teaser, a listen section with the fake audio player and upcoming shows / releases, an upcoming-events preview, a media strip, press testimonials with stars and a validated newsletter
