# Voltage Hollow — Rock Band Template

Voltage Hollow is a full multi-page rock band website template in the "dark stage" style (V1), with a fake audio player, a filterable tour dates listing and four complete, interlinked pages.
...
- A full tour dates listing with date, venue, city and sold-out / few-left status badges, narrowed by a city and month filter
...
- `index.html` — homepage: hero, about teaser, a listen section with the fake audio player and tour dates / releases, an upcoming-events preview, a media strip, press testimonials with stars and a validated newsletter
