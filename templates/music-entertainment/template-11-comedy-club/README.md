# The Laughing Crow — Comedy Club Template

The Laughing Crow is a full multi-page comedy club website template in the "elegant classical" style (V3), with a fake audio player, a filterable what's on listing and four complete, interlinked pages.
...
- A full what's on listing with date, venue, city and sold-out / few-left status badges, narrowed by a city and month filter
...
- `index.html` — homepage: hero, about teaser, a listen section with the fake audio player and what's on / releases, an upcoming-events preview, a media strip, press testimonials with stars and a validated newsletter
