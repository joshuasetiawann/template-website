# Northlight Studios — Recording Studio Template

Northlight Studios is a full multi-page recording studio website template in the "editorial artist" style (V5), with a fake audio player, a filterable sessions listing and four complete, interlinked pages.
...
- A full sessions listing with date, venue, city and sold-out / few-left status badges, narrowed by a city and month filter
...
- `index.html` — homepage: hero, about teaser, a listen section with the fake audio player and sessions / releases, an upcoming-events preview, a media strip, press testimonials with stars and a validated newsletter
