# Apex Stage Co. — Event Production Company Template

Apex Stage Co. is a full multi-page event production company website template in the "vibrant club" style (V4), with a fake audio player, a filterable projects & schedule listing and four complete, interlinked pages.

## Features

- Layout variant: **V4 (vibrant club)** — pure HTML5 / CSS3 / vanilla JavaScript, with no frameworks, fonts or images loaded from anywhere
...
- A full projects & schedule listing with date, venue, city and sold-out / few-left status badges, narrowed by a city and month filter
...
- `index.html` — homepage: hero, about teaser, a listen section with the fake audio player and projects & schedule / releases, an upcoming-events preview, a media strip, press testimonials with stars and a validated newsletter
