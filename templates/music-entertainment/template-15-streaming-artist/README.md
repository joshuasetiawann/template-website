# LUMA WAVE — Streaming Artist / Creator Template

LUMA WAVE is a full multi-page streaming artist / creator website template in the "vibrant club" style (V4), with a fake audio player, a filterable stream schedule listing and four complete, interlinked pages.
...
- A full stream schedule listing with date, venue, city and sold-out / few-left status badges, narrowed by a city and month filter
...
- `index.html` — homepage: hero, about teaser, a listen section with the fake audio player and stream schedule / releases, an upcoming-events preview, a media strip, press testimonials with stars and a validated newsletter
