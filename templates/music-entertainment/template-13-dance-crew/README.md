# Kinetic Mob — Dance Crew Template

Kinetic Mob is a full multi-page dance crew website template in the "vibrant club" style (V4), with a fake audio player, a filterable shows & battles listing and four complete, interlinked pages.
...
- A full shows & battles listing with date, venue, city and sold-out / few-left status badges, narrowed by a city and month filter
...
- `index.html` — homepage: hero, about teaser, a listen section with the fake audio player and shows & battles / releases, an upcoming-events preview, a media strip, press testimonials with stars and a validated newsletter
