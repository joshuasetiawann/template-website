# Bywater 98.3 — Radio Station Template

Bywater 98.3 is a full multi-page radio station website template in the "vinyl retro" style (V2), with a fake audio player, a filterable schedule & events listing and four complete, interlinked pages.
...
- A full schedule & events listing with date, venue, city and sold-out / few-left status badges, narrowed by a city and month filter
...
- `index.html` — homepage: hero, about teaser, a listen section with the fake audio player and schedule & events / releases, an upcoming-events preview, a media strip, press testimonials with stars and a validated newsletter
