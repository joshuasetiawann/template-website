# Brave Cells Research Fund — Cancer Research Fund Template

Brave Cells Research Fund is a calm editorial, multi-page cancer research charity template with a full donation widget, count-up impact stats and four complete, interlinked pages.

## Features

- Layout variant: **V3 (calm editorial)** — pure HTML5 / CSS3 / vanilla JavaScript, no frameworks, fonts or images
