# Al-Noor Charitable Foundation — Mosque Foundation Template

Al-Noor Charitable Foundation is a elegant foundation, multi-page faith & charity charity template with a full donation widget, count-up impact stats and four complete, interlinked pages.

## Features

- Layout variant: **V5 (elegant foundation)** — pure HTML5 / CSS3 / vanilla JavaScript, no frameworks, fonts or images
