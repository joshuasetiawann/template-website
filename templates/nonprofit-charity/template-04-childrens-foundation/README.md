# Little Lanterns Foundation — Children's Foundation Template

Little Lanterns Foundation is a vibrant community, multi-page child welfare charity template with a full donation widget, count-up impact stats and four complete, interlinked pages.

## Features

- Layout variant: **V4 (vibrant community)** — pure HTML5 / CSS3 / vanilla JavaScript, no frameworks, fonts or images
