# Stillwater Yoga Loft — Yoga Studio Template

Stillwater is a sand-and-sage calm wellness yoga template with a guided breathing-circle widget, seven-day tabbed schedule, teacher cards and an intro-month booking form.
...
- A guided breathing timer as the section's signature interaction
...
- Testimonials
- Trial / booking form
- Signature section (a guided breathing timer)
