# Aurelia Pilates Atelier — Pilates Studio Template

Aurelia is an ivory-and-mauve boutique Pilates atelier template with editorial serif headlines, a six-principle method stepper, an elegant day-grouped schedule list and a private intake enquiry form.
...
- An interactive method walk-through as the section's signature interaction
...
- Testimonials
- Trial / booking form
- Signature section (an interactive method walk-through)
