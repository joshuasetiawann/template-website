# Aurora Stillness Center — Meditation Center Template

Aurora is a lavender-mist meditation center template with gradient halo motifs, an interactive intention picker, seven-day tabbed sit schedule, guide profiles and a free first-sit reservation form.
...
- An intention selector as the section's signature interaction
...
- Testimonials
- Trial / booking form
- Signature section (an intention selector)
