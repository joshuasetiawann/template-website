# Stillpoint Therapy Practice — Therapy Practice Template

Stillpoint is a warm-gray and dusk-blue calm therapy practice template with soft arch motifs, a five-day tabbed groups schedule, accredited-therapist profiles, an honest FAQ accordion and a confidential enquiry form.
...
- An faq accordion as the section's signature interaction
...
- Testimonials
- Trial / booking form
- Signature section (an FAQ accordion)
