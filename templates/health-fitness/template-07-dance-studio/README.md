# Velvet Tempo Dance Studio — Dance Studio Template

Velvet Tempo is a fuchsia-and-violet boutique dance studio template with gradient motion-trail accents, a genre-filterable class grid, an editorial weekly schedule list and a first-class booking form.
...
- Genre-filterable classes as the section's signature interaction
...
- Testimonials
- Trial / booking form
- Signature section (genre-filterable classes)
