# Kurotora Dojo — Martial Arts Dojo Template

Kurotora is a paper-black-and-crimson martial arts dojo template with brush-stroke accents, a belt-rank progression band, etiquette accordion, editorial weekly class list and a beginner trial form.

## Features

- Two fully built pages — a long-scrolling home page and a deep "Programs & Schedule" page
- Class/visit schedule with a filterable day-by-day class journal, marked up with `data-schedule`
- A belt-rank band with etiquette accordion as the section's signature interaction
...
- Testimonials
- Trial / booking form
- Signature section (a belt-rank band with etiquette accordion)
...
This template is part of the **Health & Fitness** category of the template library — one of twenty concept-true designs (a boutique editorial style with serif headings, warm neutrals and an elegant schedule list) built to a shared release standard.
