# KinetiCare Physiotherapy — Physiotherapy Clinic Template

KinetiCare is a white-teal clinical physiotherapy template with joint-motion motifs, an interactive pain-area selector, tabbed weekly clinic schedule, credentialed clinician cards and an appointment request form.
...
- An interactive condition picker as the section's signature interaction
...
- Testimonials
- Trial / booking form
- Signature section (an interactive condition picker)
