# BrightShift Weight-Loss Studio — Weight-Loss Program Template

BrightShift is a coral-and-teal community weight-loss program template with an interactive before/after data slider, filterable cohort week plan, results wall and a cohort application form.
...
- A before/after slider as the section's signature interaction
...
- Testimonials
- Trial / booking form
- Signature section (a before/after slider)
