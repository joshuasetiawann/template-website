# BlueFin Swim School — Swimming School Template

BlueFin is a pool-white aqua-and-navy clinical swim school template with wave-lane motifs, an interactive level finder, a seven-day tabbed timetable and a free-assessment booking form.
...
- A level finder as the section's signature interaction
...
- Testimonials
- Trial / booking form
- Signature section (a level finder)
