# Salt & Cedar Spa — Spa & Wellness Retreat Template

Salt & Cedar is a cream-and-eucalyptus calm spa template with steam-curve motifs, a signature-ritual slider, seven-day tabbed bathhouse timetable and a visit reservation form.

## Features

- Two fully built pages — a long-scrolling home page and a deep "Treatments" page
- Class/visit schedule with interactive day tabs (keyboard-accessible), marked up with `data-schedule`
- A treatments ritual carousel as the section's signature interaction
...
This template is part of the **Health & Fitness** category of the template library — one of twenty concept-true designs (a calm wellness look — soft pastels, very rounded corners and gentle shadows) built to a shared release standard.
