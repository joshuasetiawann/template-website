# Alignwell Chiropractic — Chiropractic Clinic Template

Alignwell is a light green-and-slate clinical chiropractic template with a spine-curve hero motif, weekly practitioner-hours grid, care-path FAQ accordion and a new-patient exam booking form.
