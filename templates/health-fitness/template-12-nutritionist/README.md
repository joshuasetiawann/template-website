# Root & Ratio Nutrition — Nutritionist Template

Root & Ratio is a mint-and-avocado calm nutritionist template with an interactive conic plate-portion ring, five-day tabbed session schedule, registered-practitioner cards and a discovery-call form.
...
- A conic-gradient portion plate as the section's signature interaction
...
- Testimonials
- Trial / booking form
- Signature section (a conic-gradient portion plate)
