# Evergreen Movement Club — Senior Fitness Template

Evergreen is a warm-ivory community senior-fitness template with extra-large readable type, a text-size toggle, intensity-filterable week plan, gentle perk badges and a free taster booking form.

## Features

- Two fully built pages — a long-scrolling home page and a deep "Programs & Schedule" page
- Class/visit schedule with a filterable week list by category, marked up with `data-schedule`
- A larger-text comfort toggle as the section's signature interaction
...
- Testimonials
- Trial / booking form
- Signature section (a larger-text comfort toggle)
...
This template is part of the **Health & Fitness** category of the template library — one of twenty concept-true designs (a bright, friendly community-club vibe with sticker badges and a member wall) built to a shared release standard.
