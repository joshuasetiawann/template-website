# Southpaw Boxing Club — Boxing Club Template

Southpaw is an ink, boxing-red and gold club template with rope-line borders, a live fight-night countdown, six-day tabbed bell schedule and a free first-session booking form.
...
- A live event countdown as the section's signature interaction
...
- Testimonials
- Trial / booking form
- Signature section (a live event countdown)
