# Northlight Film Festival — Film Festival Template

Northlight Film Festival is an elegant dark, single-page film festival template with a live countdown, a lineup wall, a schedule, gallery, venue map and a validated RSVP form.
...
- Live countdown to 19–24 November 2026 (days / hours / minutes / seconds, updated every second)
...
4. **Change the countdown date:** open `script.js`, find the `live countdown` block near the top, and edit the ISO date string in `new Date('2026-11-19T19:00:00')` to your event's date and local time. The days/hours/minutes/seconds update automatically.
