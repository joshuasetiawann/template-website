# The Riverside Get-Together — Community Meetup Template

The Riverside Get-Together is a playful pastel, single-page community meetup template with a live countdown, a story timeline, a schedule, gallery, venue map and a validated RSVP form.
...
- Live countdown to Saturday, 11 July 2026 (days / hours / minutes / seconds, updated every second)
...
4. **Change the countdown date:** open `script.js`, find the `live countdown` block near the top, and edit the ISO date string in `new Date('2026-07-11T11:00:00')` to your event's date and local time. The days/hours/minutes/seconds update automatically.
