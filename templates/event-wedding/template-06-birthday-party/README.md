# Olivia Turns 30 — Birthday Party Template

Olivia Turns 30 is a playful pastel, single-page birthday party template with a live countdown, a story timeline, a schedule, gallery, venue map and a validated RSVP form.
...
- Live countdown to Saturday, 22 August 2026 (days / hours / minutes / seconds, updated every second)
...
4. **Change the countdown date:** open `script.js`, find the `live countdown` block near the top, and edit the ISO date string in `new Date('2026-08-22T20:00:00')` to your event's date and local time. The days/hours/minutes/seconds update automatically.
