# Aero One Reveal — Product Launch Template

Aero One Reveal is a bold festive, single-page product launch template with a live countdown, a speaker grid, a schedule, gallery, venue map and a validated RSVP form.
...
- Live countdown to Wednesday, 30 September 2026 (days / hours / minutes / seconds, updated every second)
...
4. **Change the countdown date:** open `script.js`, find the `live countdown` block near the top, and edit the ISO date string in `new Date('2026-09-30T18:30:00')` to your event's date and local time. The days/hours/minutes/seconds update automatically.
