# Eleanor & Theodore — Classic Wedding Template

Eleanor & Theodore is a romantic classic, single-page classic wedding template with a live countdown, a story timeline, a schedule, gallery, venue map and a validated RSVP form.

## Features

- Variant: **Romantic classic — centred monogram, serif type, ornament dividers and a vertical timeline**
...
- Live countdown to Saturday, 19 September 2026 (days / hours / minutes / seconds, updated every second)
...
4. **Change the countdown date:** open `script.js`, find the `live countdown` block near the top, and edit the ISO date string in `new Date('2026-09-19T16:00:00')` to your event's date and local time. The days/hours/minutes/seconds update automatically.
