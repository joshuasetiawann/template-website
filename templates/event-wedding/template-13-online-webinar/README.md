# The Growth Lab Live — Online Webinar Template

The Growth Lab Live is a clean modern, single-page online webinar template with a live countdown, a speaker grid, a schedule, gallery, venue map and a validated RSVP form.

## Features

- Variant: **Modern minimal — split hero, clean grid layout and thin accent rules**
...
- Speaker grid with monogram avatars
...
- Live countdown to Thursday, 30 July 2026 (days / hours / minutes / seconds, updated every second)
...
4. **Change the countdown date:** open `script.js`, find the `live countdown` block near the top, and edit the ISO date string in `new Date('2026-07-30T11:00:00')` to your event's date and local time. The days/hours/minutes/seconds update automatically.
