# Capital Cup 2026 — Sports Tournament Template

Capital Cup 2026 is a bold festive, single-page sports tournament template with a live countdown, a team grid, a schedule, gallery, venue map and a validated RSVP form.
...
- Live countdown to Saturday–Sunday, 8–9 August 2026 (days / hours / minutes / seconds, updated every second)
...
4. **Change the countdown date:** open `script.js`, find the `live countdown` block near the top, and edit the ISO date string in `new Date('2026-08-08T09:00:00')` to your event's date and local time. The days/hours/minutes/seconds update automatically.
