# Midnight 2027 — New Year’s Eve Gala Template

Midnight 2027 is an elegant dark, single-page new year’s eve gala template with a live countdown, a story timeline, a schedule, gallery, venue map and a validated RSVP form.
...
- Live countdown to Thursday, 31 December 2026 (days / hours / minutes / seconds, updated every second)
...
4. **Change the countdown date:** open `script.js`, find the `live countdown` block near the top, and edit the ISO date string in `new Date('2026-12-31T21:00:00')` to your event's date and local time. The days/hours/minutes/seconds update automatically.
