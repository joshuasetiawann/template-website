# Max is Turning 6! — Kids Birthday Template

Max is Turning 6! is a playful pastel, single-page kids birthday template with a live countdown, a story timeline, a schedule, gallery, venue map and a validated RSVP form.

## Features

- Variant: **Playful pastel — soft blob shapes, confetti dots and sticker-style badges**
...
- Live countdown to Saturday, 4 July 2026 (days / hours / minutes / seconds, updated every second)
...
- Inline-SVG favicon and `theme-color`; all imagery is CSS gradients / patterns plus inline SVG (plus emoji for this kids/party concept)
...
4. **Change the countdown date:** open `script.js`, find the `live countdown` block near the top, and edit the ISO date string in `new Date('2026-07-04T14:00:00')` to your event's date and local time. The days/hours/minutes/seconds update automatically.
