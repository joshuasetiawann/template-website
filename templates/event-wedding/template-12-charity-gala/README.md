# The Lumen Gala — Charity Gala Template

The Lumen Gala is an elegant dark, single-page charity gala template with a live countdown, a speaker grid, a schedule, gallery, venue map and a validated RSVP form.
...
- Donation tiers with a copyable bank reference
...
- Live countdown to Saturday, 14 November 2026 (days / hours / minutes / seconds, updated every second)
...
4. **Change the countdown date:** open `script.js`, find the `live countdown` block near the top, and edit the ISO date string in `new Date('2026-11-14T19:00:00')` to your event's date and local time. The days/hours/minutes/seconds update automatically.
