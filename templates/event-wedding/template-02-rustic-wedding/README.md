# Hazel & Jonah — Rustic Wedding Template

Hazel & Jonah is a romantic classic, single-page rustic wedding template with a live countdown, a story timeline, a schedule, gallery, venue map and a validated RSVP form.
...
- Live countdown to Saturday, 10 October 2026 (days / hours / minutes / seconds, updated every second)
...
4. **Change the countdown date:** open `script.js`, find the `live countdown` block near the top, and edit the ISO date string in `new Date('2026-10-10T15:30:00')` to your event's date and local time. The days/hours/minutes/seconds update automatically.
