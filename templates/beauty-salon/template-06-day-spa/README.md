# Stillwater Spa — Day Spa & Wellness Retreat Template

An urban day spa offering massage, facials and thermal rituals for deep, restorative calm.

A four-page, fully responsive day spa & wellness retreat website template built with pure HTML5, CSS3 and vanilla JavaScript — no frameworks, no build step, no external assets. Styled in the **luxe-minimal** variant.
