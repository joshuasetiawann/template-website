# Noir Atelier — Makeup Artist Studio Template

An editorial makeup studio creating bold, camera-ready looks for events, shoots and the spotlight.

A four-page, fully responsive makeup artist studio website template built with pure HTML5, CSS3 and vanilla JavaScript — no frameworks, no build step, no external assets. Styled in the **bold-editorial** variant.
