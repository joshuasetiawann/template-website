# Ink & Arch Studio — Microblading & Permanent Brow Studio Template

A specialist permanent makeup studio crafting natural, hair-stroke brows that last for years.

A four-page, fully responsive microblading & permanent brow studio website template built with pure HTML5, CSS3 and vanilla JavaScript — no frameworks, no build step, no external assets. Styled in the **luxe-minimal** variant.

## Features

- **Real multi-page site** — every navigation item leads to a genuine, fully-populated page.
- **Service menu & booking** — a complete, categorised treatment menu with durations and prices, plus a validated booking widget (service, date, time, artist and contact) that shows a confirmation summary.
- **Packages, memberships & FAQ** — bundle pricing, an `#pricing` section and an accessible FAQ accordion.
- **Team, gallery, story & impact stats** — a full artist line-up, CSS/SVG gallery tiles, salon story and an animated count-up statistics band.
