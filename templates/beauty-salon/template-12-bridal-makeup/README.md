# Veil & Vow — Bridal Hair & Makeup Template

A bridal beauty studio creating timeless, luminous looks for your wedding morning and beyond.

A four-page, fully responsive bridal hair & makeup website template built with pure HTML5, CSS3 and vanilla JavaScript — no frameworks, no build step, no external assets. Styled in the **bold-editorial** variant.
