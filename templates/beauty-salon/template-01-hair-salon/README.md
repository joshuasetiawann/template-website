# Maison Lumière — Hair Salon Template

A refined hair house where precision cutting and luminous colour meet calm, unhurried care.

A four-page, fully responsive hair salon website template built with pure HTML5, CSS3 and vanilla JavaScript — no frameworks, no build step, no external assets. Styled in the **luxe-minimal** variant.
