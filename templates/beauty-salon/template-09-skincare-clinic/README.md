# Lumen Skin Clinic — Advanced Skincare Clinic Template

A results-driven skincare clinic offering advanced facials and medical-grade treatments.

A four-page, fully responsive advanced skincare clinic website template built with pure HTML5, CSS3 and vanilla JavaScript — no frameworks, no build step, no external assets. Styled in the **dark-premium** variant.
