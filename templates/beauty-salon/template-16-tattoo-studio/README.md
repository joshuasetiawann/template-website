# Black Lantern Tattoo — Tattoo Studio Template

A custom tattoo studio where resident artists turn your ideas into bold, lasting work.

A four-page, fully responsive tattoo studio website template built with pure HTML5, CSS3 and vanilla JavaScript — no frameworks, no build step, no external assets. Styled in the **dark-premium** variant.
