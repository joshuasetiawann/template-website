# Goldenhour Studio — Tanning & Glow Studio Template

A modern tanning studio for flawless, streak-free glows — spray, sunbed and self-tan, done right.

A four-page, fully responsive tanning & glow studio website template built with pure HTML5, CSS3 and vanilla JavaScript — no frameworks, no build step, no external assets. Styled in the **bold-editorial** variant.
