# The Tramline Hostel — City Hostel Template

The Tramline Hostel is a warm, friendly city-hostel template with a host-crew band, a how-it-works row, pod-dorm and private-room cards and a beds-and-rooms detail page.

## Features

- Layout: **V5 friendly local — warm tones, a host story band, sticker badges and a how-it-works step row**
- Multi-page: an `index.html` overview and a dedicated `packages.html` ("Beds & Rooms") detail page
...
- Beds grid of six options, each linking through to its full write-up on the packages page
...
- Hero — Cheap sleep, great city, good people.
- Find your bunk — six beds with prices
...
- `packages.html` — the full "Beds & Rooms" detail page
...
- **Beds:** each card lives in the section marked `id="rooms"`; its "Details" link points at the matching `#pkg-n` block in `packages.html`.
