# Rambler Vans — Campervan Rental Template

Rambler Vans is a warm, retro campervan-rental template with a host-team band, a how-it-works row, fleet cards and a fleet-and-rates detail page.

## Features

- Layout: **V5 friendly local — warm tones, a host story band, sticker badges and a how-it-works step row**
- Multi-page: an `index.html` overview and a dedicated `packages.html` ("The Fleet & Hire Rates") detail page
...
- Hero — Your road trip, fully kitted, keys in hand.
- Pick your van — six the fleet with prices
- Host story band and a how-it-works step row
- Amenities — Every van comes ready
...
- `packages.html` — the full "The Fleet & Hire Rates" detail page
