# Mosswood Eco Retreat — Eco Retreat Template

Mosswood Eco Retreat is a warm, friendly off-grid eco-retreat template with a host story, a how-it-works row, cabin cards and a cabins-and-retreats detail page.

## Features

- Layout: **V5 friendly local — warm tones, a host story band, sticker badges and a how-it-works step row**
- Multi-page: an `index.html` overview and a dedicated `packages.html` ("Cabins & Retreats") detail page
...
- Hero — Unplug in a forest that's healing.
- Choose your hideaway — six cabins with prices
- Host story band and a how-it-works step row
...
- `packages.html` — the full "Cabins & Retreats" detail page
