# The Ashbourne Manor — Heritage Hotel Template

The Ashbourne Manor is an editorial heritage-hotel template for a restored manor, with oversized type, a photo-tile collage and a room-by-room detail page.

## Features

- Layout: **V4 boutique editorial — oversized type, an asymmetric photo-tile collage and fine hairline rules**
- Multi-page: an `index.html` overview and a dedicated `packages.html` ("Rooms & Suites") detail page
...
- Hero — Three centuries of welcome, gently kept.
- Rooms with a past — six rooms with prices
...
- `packages.html` — the full "Rooms & Suites" detail page
