/* Greengate Grocer — Grocery Store | vanilla JS, no dependencies */
(function () {
  'use strict';
  var CONFIG = { brand: 'Greengate Grocer', currency: '$', freeShip: 35, addedNote: 'added to your basket', emptyNote: 'Your basket is empty — the tomatoes are excellent today.', bagWord: 'basket', newsletterNote: 'Thank you — check your inbox to confirm.', checkoutNote: 'Demo grocer — checkout disabled', shipUnlocked: 'Free same-day delivery unlocked.', shipPrefix: 'Spend ', shipSuffix: ' more for free same-day delivery.' };
  ...
  /* ----- featured variant tabs ----- */
  var tabBtns = qsa('[data-tab]');
  if (tabBtns.length) {
