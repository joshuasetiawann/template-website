# Greengate Grocer — Grocery Store Template

Greengate Grocer delivers produce from 27 local farms, warm bakery and honest pantry staples the same day.
...
- `--accent` (#2F9E44), `--accent-2` (#F76707), `--accent-ink` — brand colors
- `--radius`, `--radius-sm` — corner rounding (currently 22px)
