/* HexRig — Gaming Gear Store | vanilla JS, no dependencies */
(function () {
  'use strict';
  var CONFIG = { brand: 'HexRig', currency: '$', freeShip: 80, addedNote: 'equipped to your cart', emptyNote: 'Loadout empty. Unacceptable.', bagWord: 'loadout', newsletterNote: 'Locked in — you’ll get the ping before anyone.', checkoutNote: 'Demo rig — checkout disabled', shipUnlocked: 'Free priority shipping unlocked. GG.', shipPrefix: 'Spend ', shipSuffix: ' more for free priority shipping.' };
