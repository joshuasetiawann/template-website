# HexRig — Gaming Gear Store Template

HexRig builds tournament-grade keyboards, mice and audio tuned with pro players — latency measured, not marketed.
...
- `--accent` (#22E584), `--accent-2` (#E545A8), `--accent-ink` — brand colors
