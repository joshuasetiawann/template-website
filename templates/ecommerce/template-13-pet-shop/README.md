# Wag & Whisker — Pet Shop Template

Wag & Whisker stocks toys that survive, treats that vanish and beds pets actually sleep in — picked by the shop dog.
...
- `--accent` (#FF7849), `--accent-2` (#2BA39B), `--accent-ink` — brand colors
- `--radius`, `--radius-sm` — corner rounding (currently 20px)
