/* Wag & Whisker — Pet Shop | vanilla JS, no dependencies */
(function () {
  'use strict';
  var CONFIG = { brand: 'Wag & Whisker', currency: '$', freeShip: 30, addedNote: 'added — tail wags incoming', emptyNote: 'Your basket is empty. Somewhere, a dog is disappointed.', bagWord: 'basket', newsletterNote: 'Welcome to the club — first treat ships Friday.', checkoutNote: 'Demo template — checkout disabled' };
