# Apex Motion — Sports Store Template

Apex Motion engineers run, train and recovery gear with sports scientists — tested by 400 club athletes.
...
- `--accent` (#F24E1E), `--accent-2` (#11296B), `--accent-ink` — brand colors
