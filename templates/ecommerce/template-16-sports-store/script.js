/* Apex Motion — Sports Store | vanilla JS, no dependencies */
(function () {
  'use strict';
  var CONFIG = { brand: 'Apex Motion', currency: '$', freeShip: 60, addedNote: 'added to your kit', emptyNote: 'Kit bag’s empty. Day one starts now.', bagWord: 'kit', newsletterNote: 'Thank you — check your inbox to confirm.', checkoutNote: 'Demo kit room — checkout disabled', shipUnlocked: 'Free shipping unlocked — warm-down complete.', shipPrefix: 'Spend ', shipSuffix: ' more for free shipping.' };
