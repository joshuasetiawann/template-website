# Aurum & Crown — Watch Store Template

Aurum & Crown assembles mechanical timepieces by hand in Geneva — explore dress, sport and chronograph references.

## Features

- Layout variant: **classic boutique** — pure HTML5/CSS3/vanilla JS, no dependencies
- Add-to-cart with animated badge counter and rich toast confirmations (product name + "View cart" action)
