# Nebula Vault — Digital Product Store Template

Nebula Vault sells UI kits, icon systems and templates from working designers — buy once, download forever.
...
- `--accent` (#8B5CF6), `--accent-2` (#C084FC), `--accent-ink` — brand colors
- `--radius`, `--radius-sm` — corner rounding (currently 16px)
