# Grain & Form — Furniture Store Template

Grain & Form makes solid-wood furniture to order — shop seating, tables, storage and lighting built to be kept.
...
- `--accent` (#8A5A3B), `--accent-2` (#7C8B6F), `--accent-ink` — brand colors
- `--radius`, `--radius-sm` — corner rounding (currently 6px)
