/* Grain & Form — Furniture Store | vanilla JS, no dependencies */
(function () {
  'use strict';
  var CONFIG = { brand: 'Grain & Form', currency: '$', freeShip: 499, addedNote: 'added to your cart', emptyNote: 'Your cart is empty.', bagWord: 'cart', newsletterNote: 'Thank you — check your inbox to confirm.', checkoutNote: 'Demo template — checkout disabled', shipUnlocked: 'White-glove delivery unlocked — on us.', shipPrefix: 'Spend ', shipSuffix: ' more to unlock free white-glove delivery.' };
