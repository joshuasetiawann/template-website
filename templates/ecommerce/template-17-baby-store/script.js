/* Little Lark — Baby Store | vanilla JS, no dependencies */
(function () {
  'use strict';
  var CONFIG = { brand: 'Little Lark', currency: '$', freeShip: 45, addedNote: 'tucked into your basket', emptyNote: 'Your basket is empty — naptime won’t last forever.', bagWord: 'basket', newsletterNote: 'Welcome — your first letter arrives this week.', checkoutNote: 'Demo template — checkout disabled' };
