# Little Lark — Baby Store Template

Little Lark makes organic-cotton baby essentials with safe dyes — soft things for small beginnings.

## Features

- Layout variant: **promo retail** — pure HTML5/CSS3/vanilla JS, no dependencies
- Add-to-cart with animated badge counter and rich toast confirmations (product name + "View basket" action)
...
- `--accent` (#7CC6BB), `--accent-2` (#F4A87C), `--accent-ink` — brand colors
- `--radius`, `--radius-sm` — corner rounding (currently 26px)
