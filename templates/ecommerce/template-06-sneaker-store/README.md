# Hyperlace — Sneaker Store Template

Hyperlace drops performance and lifestyle sneakers in volt and black — shop the AW26 drop before it sells out.
...
- `--accent` (#B5E61D), `--accent-2` (#101010), `--accent-ink` — brand colors
