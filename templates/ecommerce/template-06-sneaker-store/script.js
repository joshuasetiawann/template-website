/* Hyperlace — Sneaker Store | vanilla JS, no dependencies */
(function () {
  'use strict';
  var CONFIG = { brand: 'Hyperlace', currency: '$', freeShip: 120, addedNote: 'laced into your cart', emptyNote: 'Cart’s empty. The wall is right there.', bagWord: 'cart', newsletterNote: 'Thank you — check your inbox to confirm.', checkoutNote: 'Demo drop — checkout disabled', shipUnlocked: 'Free express shipping unlocked.', shipPrefix: 'Spend ', shipSuffix: ' more for free express shipping.' };
