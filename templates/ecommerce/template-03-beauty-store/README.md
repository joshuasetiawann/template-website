# Rosaline — Beauty Store Template

Rosaline makes skin-first, cruelty-free makeup — shop buildable color for lips, eyes and complexion.

## Features

- Layout variant: **promo retail** — pure HTML5/CSS3/vanilla JS, no dependencies
...
- Announcement bar and floating product cards in the hero
- Featured product with JS variant tabs (thumbnail swatches)
...
- `--accent` (#D4527E), `--accent-2` (#C99A3F), `--accent-ink` — brand colors
- `--radius`, `--radius-sm` — corner rounding (currently 18px)
