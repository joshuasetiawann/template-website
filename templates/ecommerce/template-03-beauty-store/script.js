/* Rosaline — Beauty Store | vanilla JS, no dependencies */
(function () {
  'use strict';
  var CONFIG = { brand: 'Rosaline', currency: '$', freeShip: 40, addedNote: 'is in your bag', emptyNote: 'Your bag is empty — the bestsellers are calling.', bagWord: 'bag', newsletterNote: 'Thank you — check your inbox to confirm.', checkoutNote: 'Demo template — checkout disabled' };
