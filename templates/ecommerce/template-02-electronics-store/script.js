/* Nordvolt — Electronics Store | vanilla JS, no dependencies */
(function () {
  'use strict';
  var CONFIG = { brand: 'Nordvolt', currency: '$', freeShip: 75, addedNote: 'added to your cart', emptyNote: 'Your cart is empty.', bagWord: 'cart', newsletterNote: 'Welcome aboard — your 10% code is on its way.', checkoutNote: 'Demo store — checkout disabled', shipUnlocked: 'Nice — you unlocked free shipping.', shipPrefix: 'Spend ', shipSuffix: ' more to unlock free shipping.' };
