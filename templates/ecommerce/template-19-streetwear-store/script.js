/* Static Youth — Streetwear Store | vanilla JS, no dependencies */
(function () {
  'use strict';
  var CONFIG = { brand: 'Static Youth', currency: '$', freeShip: 90, addedNote: 'secured', emptyNote: 'Cart empty. Drop 09 won’t wait.', bagWord: 'cart', newsletterNote: 'ON THE LIST. Don’t sleep on the email.', checkoutNote: 'DEMO DROP — CHECKOUT OFF', shipUnlocked: 'FREE SHIPPING UNLOCKED.', shipPrefix: 'Spend ', shipSuffix: ' more for free worldwide shipping.' };
