/* Eunoia Skin — Skincare Store | vanilla JS, no dependencies */
(function () {
  'use strict';
  var CONFIG = { brand: 'Eunoia Skin', currency: '$', freeShip: 50, addedNote: 'added to your bag', emptyNote: 'Your bag is empty — your skin has ideas.', bagWord: 'bag', newsletterNote: 'Enrolled — lesson one lands tomorrow morning.', checkoutNote: 'Demo template — checkout disabled' };
