# Ondine & Or — Jewelry Store Template

Ondine & Or makes fine jewelry to order in Antwerp — recycled 14k gold, certified lab diamonds, honest prices.
...
- `--accent` (#B08D57), `--accent-2` (#33302B), `--accent-ink` — brand colors
