/* Ondine & Or — Jewelry Store | vanilla JS, no dependencies */
(function () {
  'use strict';
  var CONFIG = { brand: 'Ondine & Or', currency: '$', freeShip: 0, addedNote: 'added — wrapped in velvet', emptyNote: 'Your cart is empty — the case is just there.', bagWord: 'cart', newsletterNote: 'Request received — our atelier will write within a day.', checkoutNote: 'Demo template — checkout disabled' };
