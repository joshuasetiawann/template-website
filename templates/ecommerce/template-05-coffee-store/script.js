/* Kiln & Crema — Coffee Store | vanilla JS, no dependencies */
(function () {
  'use strict';
  var CONFIG = { brand: 'Kiln & Crema', currency: '$', freeShip: 30, addedNote: 'is in your cart', emptyNote: 'Your cart is empty — the kettle is already on.', bagWord: 'cart', newsletterNote: 'Thank you — check your inbox to confirm.', checkoutNote: 'Demo template — checkout disabled' };
