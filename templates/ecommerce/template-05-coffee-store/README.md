# Kiln & Crema — Coffee Store Template

Kiln & Crema roasts small-lot, single-origin coffee in Bergen and ships within 48 hours of the drum.
...
- `--accent` (#C08A3E), `--accent-2` (#EFE3D0), `--accent-ink` — brand colors
- `--radius`, `--radius-sm` — corner rounding (currently 4px)
