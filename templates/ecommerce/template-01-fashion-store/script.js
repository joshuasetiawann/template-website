/* Maison Linnea — Fashion Store | vanilla JS, no dependencies */
(function () {
  'use strict';
  var CONFIG = { brand: 'Maison Linnea', currency: '$', freeShip: 150, addedNote: 'added to your bag', emptyNote: 'Your bag is empty — the lookbook is a good place to start.', bagWord: 'bag', newsletterNote: 'Thank you — check your inbox to confirm.', checkoutNote: 'Demo template — checkout disabled' };
