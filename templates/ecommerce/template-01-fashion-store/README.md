# Maison Linnea — Fashion Store Template

Considered womenswear in natural fibres — shop the Maison Linnea autumn collection of coats, knits and silks.
...
- `--accent` (#B56A4E), `--accent-2` (#221B12), `--accent-ink` — brand colors
