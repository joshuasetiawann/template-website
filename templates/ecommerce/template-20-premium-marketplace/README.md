# Vetted & Co. — Premium Marketplace Template

Vetted & Co. is a curated marketplace for heirloom-grade goods — every maker vetted, every item authenticated.
...
- `--accent` (#10B981), `--accent-2` (#C7CCD1), `--accent-ink` — brand colors
