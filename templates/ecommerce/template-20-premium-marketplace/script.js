/* Vetted & Co. — Premium Marketplace | vanilla JS, no dependencies */
(function () {
  'use strict';
  var CONFIG = { brand: 'Vetted & Co.', currency: '$', freeShip: 200, addedNote: 'added to your cart', emptyNote: 'Your cart is empty — the floor is open.', bagWord: 'cart', newsletterNote: 'Done — the next shortlist reaches you first.', checkoutNote: 'Demo marketplace — checkout disabled', shipUnlocked: 'Insured courier shipping unlocked — on the house.', shipPrefix: 'Spend ', shipSuffix: ' more for free insured courier shipping.' };
