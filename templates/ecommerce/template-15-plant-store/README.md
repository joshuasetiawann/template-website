# Fern & Loam — Plant Store Template

Fern & Loam ships greenhouse-grown plants matched to your light, plastic-free and backed by a 30-day grow guarantee.

## Features

- Layout variant: **showcase** — pure HTML5/CSS3/vanilla JS, no dependencies
...
- Filter sidebar on desktop that collapses to chips on mobile (live grid filtering)
- Featured product with a JS spec accordion
