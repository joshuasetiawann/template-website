/* Fern & Loam — Plant Store | vanilla JS, no dependencies */
(function () {
  'use strict';
  var CONFIG = { brand: 'Fern & Loam', currency: '$', freeShip: 75, addedNote: 'is potted in your cart', emptyNote: 'Your cart is empty — your windowsill disagrees with that choice.', bagWord: 'cart', newsletterNote: 'Subscribed — first leaf mail arrives Sunday.', checkoutNote: 'Demo template — checkout disabled' };
