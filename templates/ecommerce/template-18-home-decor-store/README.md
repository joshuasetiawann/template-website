# Hearth & Hue — Home Decor Store Template

Hearth & Hue curates textiles, ceramics and lighting from forty small European makers — pieces with fingerprints on them.
...
- `--accent` (#5B6E8C), `--accent-2` (#B06E4F), `--accent-ink` — brand colors
- `--radius`, `--radius-sm` — corner rounding (currently 10px)
