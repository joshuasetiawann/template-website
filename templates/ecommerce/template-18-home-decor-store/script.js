/* Hearth & Hue — Home Decor Store | vanilla JS, no dependencies */
(function () {
  'use strict';
  var CONFIG = { brand: 'Hearth & Hue', currency: '$', freeShip: 150, addedNote: 'added to your cart', emptyNote: 'Your cart is empty — the gallery is open.', bagWord: 'cart', newsletterNote: 'Subscribed — April’s room lands next week.', checkoutNote: 'Demo template — checkout disabled' };
