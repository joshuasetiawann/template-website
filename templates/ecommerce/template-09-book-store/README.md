# The Marginalia — Book Store Template

The Marginalia is an independent bookshop with staff notes in every cover — browse fiction, poetry and signed editions.

## Features

- Layout variant: **editorial** — pure HTML5/CSS3/vanilla JS, no dependencies
- Add-to-cart with animated badge counter and rich toast confirmations (product name + "View pile" action)
...
- `--accent` (#8C2F39), `--accent-2` (#2A1E1A), `--accent-ink` — brand colors
- `--radius`, `--radius-sm` — corner rounding (currently 2px)
