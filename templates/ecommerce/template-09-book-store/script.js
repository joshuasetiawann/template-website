/* The Marginalia — Book Store | vanilla JS, no dependencies */
(function () {
  'use strict';
  var CONFIG = { brand: 'The Marginalia', currency: '$', freeShip: 25, addedNote: 'is on your pile', emptyNote: 'Your pile is empty — a dangerous state to be in.', bagWord: 'pile', newsletterNote: 'Welcome to the club — Thursday details are on the way.', checkoutNote: 'Demo template — checkout disabled' };
