# William Ashford — Management Consultant Portfolio Template

A pure HTML/CSS/JS portfolio template for a management consultant, styled as a split layout with a sticky identity panel beside a scrolling content column.
...
- Extras included: Blog / notes teaser cards, Availability badge
...
- `--radius` — global corner radius (currently 8px)
