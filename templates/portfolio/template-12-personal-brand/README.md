# Adrian Volkov — Brand Strategist & Speaker Portfolio Template

A pure HTML/CSS/JS portfolio template for a brand strategist & speaker, styled as a dark showcase with a marquee skill strip, masonry gallery and quick-view modal.
...
- JavaScript interactions:
  ...
  - Project quick-view modal that closes on overlay click and the Escape key
...
- Atmospheric dark hero
- Scrolling marquee skill strip
- Masonry project gallery with quick-view modal
- Capability meters
- Experience timeline
...
- `--radius` — global corner radius (currently 6px)
