/* Luca Moreau — Motion Designer · portfolio interactions
   Template: template-08-motion-designer (variant V3, dark showcase)
   Vanilla JS only. Every selector is guarded — safe to delete sections. */

(function () {
  'use strict';
  var SITE = { slug: 'template-08-motion-designer', owner: 'Luca Moreau' };
...
/* ============================================================
   Release 2 — case-study page + link wiring · template-08-motion-designer
...
(function () {
  ...
  if (!caseRoot) { return; }
  var OWNER = "Luca Moreau";
  var CASES = [
    {
      "t": "Flux Festival identity in motion",
      "tags": [
        "Identity",
        "Kinetic type"
      ],
      "lede": "Generative type system where every poster, story and stinger derives from one oscillating grid.",
      "client": "Flux Festival",
      "year": "2025",
      "duration": "6 weeks",
      "ov1": "An electronic-arts festival wanted an identity that performs rather than sits. I directed the kinetic type system for screens, stage and street.",
      "ov2": "The wordmark behaves like a signal: it stretches on bass, fractures on glitch cues, and reassembles for sponsors. VJs got a live rig, not a logo sheet.",
      "ch": "The identity had to survive operators improvising at 2am. We shipped behaviours with safe ranges instead of fixed animations — chaos, bounded.",
      "met": [
        [
          "30",
          "",
          "Screens running the system live"
        ],
        [
          "12",
          "",
          "Type behaviours defined"
        ],
        [
          "6",
          "",
          "Weeks from brief to festival"
        ]
      ],
      "figs": [
        [
          "#8B5CF6",
          "#22D3EE",
          "Style frames from round one"
        ],
        [
          "#7C3AED",
          "#0EA5E9",
          "Animatic timing chart on the wall"
        ],
        [
          "#A855F7",
          "#101936",
          "Easing-curve sheet for the system"
        ]
      ],
      "q": [
        "The identity was the best act on three of our stages. VJs are still trading presets from the rig.",
        "Nadia Iqbal",
        "Creative Producer, Flux"
      ]
    },
    {
      "t": "Nimbus OS micro-interactions",
      "tags": [
        "Product",
        "UI motion"
      ],
      "lede": "90 documented animations with tokenized durations and easings; devs rebuilt them pixel-true in Rive.",
      "client": "Nimbus Computing",
      "year": "2024",
      "duration": "4 months",
      "ov1": "An operating system’s feel lives in its micro-interactions. I directed motion for Nimbus OS — every open, dismiss, drag and spring.",
      "ov2": "We defined a physics: light objects snap, heavy surfaces glide, nothing fades without a reason. 120 interaction specs shipped with engine-ready curves.",
      "ch": "At OS scale, motion is performance engineering. Every animation was budgeted in milliseconds and tested on the cheapest device Nimbus ships.",
      "met": [
        [
          "120",
          "",
          "Interaction specs delivered"
        ],
        [
          "16",
          "ms",
          "Frame budget honoured"
        ],
        [
          "9",
          "",
          "Patterns in the OS kit"
        ]
      ],
      "figs": [
        [
          "#7C3AED",
          "#0EA5E9",
          "Render farm queue, delivery week"
        ],
        [
          "#A855F7",
          "#101936",
          "Guideline film still — do & don’t"
        ],
        [
          "#6D28D9",
          "#67E8F9",
          "Final frame as broadcast"
        ]
      ],
      "q": [
        "The OS finally feels like one material. Reviewers called it \"calm\" — that word came straight from the motion spec.",
        "Felix Berger",
        "VP Design, Nimbus"
      ]
    },
    {
      "t": "“Signal/Noise” title sequence",
      "tags": [
        "Titles",
        "Broadcast"
      ],
      "lede": "Tech conference opener mixing scan-processed type with particle reveals; 40k loop views.",
      "client": "Pulsar Originals",
      "year": "2023",
      "duration": "8 weeks",
      "ov1": "A broadcast anthology series about signal and surveillance needed titles that feel like intercepted transmission. I directed and animated the sequence.",
      "ov2": "Sixty seconds of type degrading through analogue noise — names arrive as interference patterns that resolve a frame before legibility demands it.",
      "ch": "The sequence runs before every episode, so it hides variations: four alternate passes that only attentive viewers ever consciously notice.",
      "met": [
        [
          "60",
          "",
      ...
      "q": [
        "The titles set the show’s paranoia better than our cold opens. Twitter freeze-frames them weekly.",
        "Greta Salomon",
        "Showrunner, Signal/Noise"
      ]
    },
    {
      "t": "Orbit fintech logo behavior",
      "tags": [
        "Identity",
        "Product"
      ],
      "lede": "A logo that responds to transaction states — idle, processing, success — in under 600ms each.",
      "client": "Orbit Financial",
      "year": "2024",
      "duration": "5 weeks",
      "ov1": "Orbit’s logo was static in a product full of state changes. I designed its behaviour: how it loads, succeeds, fails and idles.",
      "ov2": "The mark’s ring became a status instrument — orbit speed for processing, a settle-bounce for success, a respectful stall for errors. No spinners anywhere.",
      "ch": "A logo that moves in a finance app must never feel frivolous. Every behaviour maps to a system state; nothing animates for decoration.",
      "met": [
        [
          "14",
          "",
          "Logo states designed"
        ],
        [
          "0",
          "",
          "Generic spinners remaining"
        ],
        [
          "800",
          "ms",
          "Longest permitted animation"
        ]
      ],
      "figs": [
        [
      ...
      "q": [
        "Users now watch the logo instead of refreshing. Support tickets asking \"did my transfer go through\" dropped visibly.",
        "Carla Mendes",
        "Product Lead, Orbit"
      ]
    },
    {
      "t": "Lyric video — “Glasshouse”",
      "tags": [
        "Music",
        "Kinetic type"
      ],
      "lede": "3-minute kinetic type piece synced phoneme-by-phoneme; 2.1M views and one jealous label.",
      "client": "Glasshouse (band)",
      "year": "2023",
      "duration": "7 weeks",
      "ov1": "A lyric video for a track about living transparently online — four minutes of kinetic type through glass refraction and screen-glare physics.",
      "ov2": "Each verse renders lyrics as UI debris — notifications, captions, autocomplete — that the chorus shatters into legible calm. One take, no cuts.",
      "ch": "Lyric videos drown in effects. The discipline was a single visual rule — everything is glass — pushed until it carried the whole narrative.",
      "met": [
        [
          "4",
          "",
          "Minutes, single continuous shot"
        ],
        [
          "2",
          "M",
        ...
        [
          "1",
          "",
          "Music-video festival selection"
        ]
      ],
      "figs": [
        [
      ...
      "q": [
        "The video reads the song better than our album art. Fans tattoo frames from it, which is terrifying and wonderful.",
        "June Akel",
        "Vocalist, Glasshouse"
      ]
    },
    {
      "t": "Motion guidelines for Helio",
      "tags": [
        "Systems",
        "Identity"
      ],
      "lede": "A 60-page living spec: principles, dos/don’ts, and exportable curve presets for three teams.",
      "client": "Helio Systems",
      "year": "2024",
      "duration": "9 weeks",
      "ov1": "Helio’s product teams animated by vibe. I wrote the motion guidelines: principles, tokens and a film that shows the difference between right and almost.",
      "ov2": "Duration and easing tokens shipped to code; choreography rules for entrances, exits and emphasis; and a do-don’t film teams actually watch.",
      "ch": "Guidelines fail when they read like law. Ours teach physics with humour — the don’t examples are deliberately, memorably terrible.",
      "met": [
        [
          "24",
          "",
      ...
      "q": [
        "The guideline film did in nine minutes what two years of design reviews could not. Teams quote the don’ts at each other.",
        "Anders Vik",
        "Head of Design, Helio"
      ]
    }
  ];
  ...
  put('data-case-kicker', 'Case study · ' + "Motion Director" + ' · ' + data.year);
