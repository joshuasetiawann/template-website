# Luca Moreau — Motion Designer Portfolio Template

A pure HTML/CSS/JS portfolio template for a motion designer, styled as a dark showcase with a marquee skill strip, masonry gallery and quick-view modal.
