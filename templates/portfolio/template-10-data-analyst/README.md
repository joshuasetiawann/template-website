# Marcus Oyelaran — Data Analyst Portfolio Template

A pure HTML/CSS/JS portfolio template for a data analyst, styled as a name-first, big-typography one-pager with a filterable project grid.
