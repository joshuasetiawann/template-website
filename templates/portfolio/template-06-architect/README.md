# Tomas Reyes — Architect Portfolio Template

A pure HTML/CSS/JS portfolio template for a architect, styled as an editorial, serif-led resume with a numbered case index and experience table.
