# Theo Okafor — Design & CS Student Portfolio Template

A pure HTML/CSS/JS portfolio template for a design & cs student, styled as a playful bento-grid layout with stat cards and tag-filtered projects.
...
- `--radius` — global corner radius (currently 24px)
