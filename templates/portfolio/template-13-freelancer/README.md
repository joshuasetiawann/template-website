# Nadia Haddad — Freelance Web Designer & Developer Portfolio Template

A pure HTML/CSS/JS portfolio template for a freelance web designer & developer, styled as a name-first, big-typography one-pager with a filterable project grid.
...
- Big-type hero with CTAs
- About me with skill chips
- Animated skill bars
- Filterable project grid (6 projects)
- Experience timeline
- Testimonial / highlights band
