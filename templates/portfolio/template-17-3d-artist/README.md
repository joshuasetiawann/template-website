# Zara Nilsson — 3D Artist Portfolio Template

A pure HTML/CSS/JS portfolio template for a 3d artist, styled as a dark showcase with a marquee skill strip, masonry gallery and quick-view modal.
...
- Extras included: Currently-learning card, Availability badge
...
- `--radius` — global corner radius (currently 16px)
