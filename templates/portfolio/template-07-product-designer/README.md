# Priya Raghavan — Product Designer Portfolio Template

A pure HTML/CSS/JS portfolio template for a product designer, styled as a split layout with a sticky identity panel beside a scrolling content column.
...
- JavaScript interactions:
  ...
  - Skill bars that animate into view via IntersectionObserver
  - Client-side contact form validation with inline, screen-reader-friendly errors
...
- Extras included: Tool-stack wall, Currently-learning card, Availability badge
...
- Mobile header (the identity panel collapses into it under 960px)
- Sticky identity panel: avatar, role, section nav, social links
- About me with toolbox chips
- Skill bars animated on scroll
- Project rows (6 projects)
- Experience timeline
...
- `--radius` — global corner radius (currently 20px)
