# Hana Sato — Illustrator Portfolio Template

A pure HTML/CSS/JS portfolio template for a illustrator, styled as an editorial, serif-led resume with a numbered case index and experience table.
...
- `--radius` — global corner radius (currently 22px)
