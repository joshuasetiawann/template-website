# Eleanor Whitfield — Copywriter Portfolio Template

A pure HTML/CSS/JS portfolio template for a copywriter, styled as an editorial, serif-led resume with a numbered case index and experience table.
...
- `--radius` — global corner radius (currently 4px)
