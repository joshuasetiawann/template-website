# Jae-won Park — Video Editor Portfolio Template

A pure HTML/CSS/JS portfolio template for a video editor, styled as a playful bento-grid layout with stat cards and tag-filtered projects.
