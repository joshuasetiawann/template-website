# Margaret Liu — Writer & Essayist Portfolio Template

A pure HTML/CSS/JS portfolio template for a writer & essayist, styled as a name-first, big-typography one-pager with a filterable project grid.
...
- Extras included: Awards & recognition list, Currently-learning card, Availability badge
...
- `--radius` — global corner radius (currently 3px)
