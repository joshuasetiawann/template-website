# Devon Carter — Frontend Developer Portfolio Template

A pure HTML/CSS/JS portfolio template for a frontend developer, styled as a name-first, big-typography one-pager with a filterable project grid.
