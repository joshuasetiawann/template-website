# Camille Dubois — Marketing Strategist Portfolio Template

A pure HTML/CSS/JS portfolio template for a marketing strategist, styled as a split layout with a sticky identity panel beside a scrolling content column.
...
- Extras included: Awards & recognition list, Availability badge
...
- `--radius` — global corner radius (currently 12px)
