# Metricore — Analytics Dashboard Template

A dense analytics dashboard template with icon-rail navigation, multi-series traffic line chart, sparkline stats, top sources list and pages table.
...
- Sessions by channel (line chart)
- Top pages — data table with 9 realistic rows, status pills and row actions
- Alerts & events — timestamped feed
- Top sources (top items list)
...
- **Pages** (`#/list`) — a searchable, paginated, CSV-exportable table of 20 pages.
- **Traffic reports** (`#/reports`) — two extra charts, three insight tiles and key takeaways.
