/* Metricore — analytics dashboard interactions (vanilla JS, no dependencies) */
(function () {
  'use strict';
  var doc = document;
  var body = doc.body;
  ...
  /* ----- Chart data (Metricore sample dataset) ----- */
  var CHANNELS = [{"name": "Organic", "color": "#2563EB", "area": true, "dots": true, "data": [9.2, 10.1, 9.6, 11.4, 11.0, 12.8, 12.1, 13.6, 14.9, 14.2, 16.4]}, {"name": "Paid", "color": "#F59E0B", "data": [5.1, 5.6, 5.2, 6.0, 5.8, 6.6, 6.2, 7.0, 7.4, 7.1, 7.9]}, {"name": "Referral", "color": "#14B8A6", "data": [2.4, 2.6, 2.5, 2.9, 2.8, 3.2, 3.0, 3.5, 3.8, 3.6, 4.1]}];
  var CHANNELSLabels = ["Jun 1", "Jun 2", "Jun 3", "Jun 4", "Jun 5", "Jun 6", "Jun 7", "Jun 8", "Jun 9", "Jun 10", "Jun 11"];
  function drawCHANNELS(skip) {
    renderLine('trafficLine', CHANNELS, { labels: CHANNELSLabels, skipAnim: skip, fmtY: function (v) { return v + 'k'; } });
  }
  drawCHANNELS(false);
  redraws.push(function () { drawCHANNELS(true); });


  /* ----- Metricore release upgrades: year, shimmer, reveal, pagination, export, tooltips ----- */
  /* ----- Reports view charts (rendered lazily on first show) ----- */
  window.__renderReports = function () {
    renderLine('repChartA', [{"name": "Organic", "color": "var(--accent)", "area": true, "dots": true, "data": [18, 21, 19, 24, 26, 23, 28]}, {"name": "Paid", "color": "var(--accent-2)", "dots": true, "data": [9, 11, 10, 13, 12, 14, 13]}], { labels: ["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"], fmtY: function (v) { return v + 'k'; } });
    renderLine('repChartB', [{"name": "Conversion", "color": "var(--accent)", "area": true, "dots": true, "data": [2.4, 2.6, 2.5, 2.8, 3.0, 2.9, 3.1, 3.3, 3.2, 3.4, 3.6, 3.5]}], { labels: ["W1", "W2", "W3", "W4", "W5", "W6", "W7", "W8", "W9", "W10", "W11", "W12"], fmtY: function (v) { return v + '%'; } });
  ...
  var CHANNELS_A = CHANNELS, CHANNELS_LA = CHANNELSLabels;
  var CHANNELS_B = [{"name": "Organic", "color": "#2563EB", "area": true, "dots": true, "data": [8.1, 8.9, 8.4, 9.8, 9.5, 10.9, 10.4, 11.6, 12.6, 12.1, 13.8]}, {"name": "Paid", "color": "#F59E0B", "data": [4.6, 5.0, 4.7, 5.4, 5.2, 5.9, 5.6, 6.3, 6.6, 6.4, 7.1]}, {"name": "Referral", "color": "#14B8A6", "data": [2.1, 2.3, 2.2, 2.6, 2.5, 2.9, 2.7, 3.1, 3.4, 3.2, 3.7]}];
  var CHANNELS_LB = ["May 21", "May 22", "May 23", "May 24", "May 25", "May 26", "May 27", "May 28", "May 29", "May 30", "May 31"];
  function applyRange(k) {
    CHANNELS = k === 'b' ? CHANNELS_B : CHANNELS_A;
    CHANNELSLabels = k === 'b' ? CHANNELS_LB : CHANNELS_LA;
    drawCHANNELS(false);
  }
