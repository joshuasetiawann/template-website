# Funnelfox — Marketing Dashboard Template

A bright marketing dashboard template with grouped spend-vs-revenue bar chart, lead goal gauge, quick actions and campaign performance table.
...
- Spend vs revenue by month (bars chart)
- Campaign performance — data table with 7 realistic rows, status pills and row actions
- Campaign feed — timestamped feed
- Monthly lead goal (goal gauge)
...
- **Campaigns** (`#/list`) — a searchable, paginated, CSV-exportable table of 20 campaigns.
- **Marketing reports** (`#/reports`) — two extra charts, three insight tiles and key takeaways.
