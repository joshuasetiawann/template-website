# Sprintdeck — Project Management Dashboard Template

A two-tone project management dashboard template with slate sidebar, sprint burnup line chart, epic progress list and tabbed task table.
...
- Sprint burnup (line chart)
- Task board — data table with 7 realistic rows, status pills and row actions
- Board activity — timestamped feed
- Epic progress (progress list)
...
- **Tasks** (`#/list`) — a searchable, paginated, CSV-exportable table of 20 tasks.
- **Sprint reports** (`#/reports`) — two extra charts, three insight tiles and key takeaways.
