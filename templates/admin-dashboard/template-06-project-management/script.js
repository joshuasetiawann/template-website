/* Sprintdeck — project management dashboard interactions (vanilla JS, no dependencies) */
(function () {
  'use strict';
  var doc = document;
  var body = doc.body;
  ...
  /* ----- Chart data (Sprintdeck sample dataset) ----- */
  var BURNUP = [{"name": "Completed", "color": "#0EA5E9", "area": true, "dots": true, "data": [4, 9, 15, 22, 26, 31, 36, 42, 47, 52]}, {"name": "Scope", "color": "#94A3B8", "dash": true, "data": [58, 58, 58, 60, 60, 60, 62, 62, 62, 62]}];
  var BURNUPLabels = ["Mon", "Tue", "Wed", "Thu", "Fri", "Mon", "Tue", "Wed", "Thu", "Fri"];
  function drawBURNUP(skip) {
    renderLine('burnLine', BURNUP, { labels: BURNUPLabels, skipAnim: skip });
  }
  drawBURNUP(false);
  redraws.push(function () { drawBURNUP(true); });


  /* ----- Sprintdeck release upgrades: year, shimmer, reveal, pagination, export, tooltips ----- */
  /* ----- Reports view charts (rendered lazily on first show) ----- */
  window.__renderReports = function () {
    renderLine('repChartA', [{"name": "Remaining", "color": "var(--accent)", "area": true, "dots": true, "data": [59, 55, 50, 47, 41, 35, 28, 21, 12]}, {"name": "Ideal", "color": "var(--muted)", "dash": true, "data": [59, 52, 45, 38, 31, 24, 17, 10, 0]}], { labels: ["D1", "D2", "D3", "D4", "D5", "D6", "D7", "D8", "D9"], fmtY: function (v) { return '' + v; } });
    renderLine('repChartB', [{"name": "Velocity", "color": "var(--accent-2)", "area": true, "dots": true, "data": [44, 49, 47, 53, 50, 58]}], { labels: ["S19", "S20", "S21", "S22", "S23", "S24"], fmtY: function (v) { return '' + v; } });
  ...
  var BURNUP_A = BURNUP;
  var BURNUP_B = [{"name": "Completed", "color": "#0EA5E9", "area": true, "dots": true, "data": [3, 7, 12, 18, 21, 26, 30, 34, 39, 44]}, {"name": "Scope", "color": "#94A3B8", "dash": true, "data": [52, 52, 54, 54, 54, 56, 56, 56, 56, 56]}];
  function applyRange(k) {
    BURNUP = k === 'b' ? BURNUP_B : BURNUP_A;
    drawBURNUP(false);
  }
