/* Tokentrace — ai usage dashboard interactions (vanilla JS, no dependencies) */
(function () {
  'use strict';
  var doc = document;
  var body = doc.body;
  ...
  if (themeBtn) {
    ...
    var THEME_KEY = 'template-19-ai-usage-dashboard-theme';
    try {
  ...
  /* ----- Chart data (Tokentrace sample dataset) ----- */
  var TOKENS = [{"label": "May 29", "values": [16.2, 9.8]}, {"label": "May 30", "values": [14.8, 9.1]}, {"label": "May 31", "values": [12.4, 7.6]}, {"label": "Jun 1", "values": [18.6, 11.2]}, {"label": "Jun 2", "values": [19.4, 12.0]}, {"label": "Jun 3", "values": [17.8, 10.9]}, {"label": "Jun 4", "values": [21.2, 13.4]}, {"label": "Jun 5", "values": [22.6, 14.1]}, {"label": "Jun 6", "values": [16.9, 10.2]}, {"label": "Jun 7", "values": [15.4, 9.6]}, {"label": "Jun 8", "values": [23.8, 15.0]}, {"label": "Jun 9", "values": [25.1, 16.2]}, {"label": "Jun 10", "values": [27.4, 17.8]}, {"label": "Jun 11", "values": [29.6, 18.6]}];
  renderBars('tokenBars', TOKENS, {"suffix": "M", "tips": false});
  var MODELSHARE = [{"label": "nova-large-3", "value": 21.2, "color": "#22E584"}, {"label": "nova-mini", "value": 13.5, "color": "#A78BFA"}, {"label": "pulse-vision", "value": 8.2, "color": "#5BA0F2"}, {"label": "echo-embed", "value": 5.3, "color": "#E8A33D"}];
  renderDonut('modelDonut', MODELSHARE);


  /* ----- Tokentrace release upgrades: year, shimmer, reveal, pagination, export, tooltips ----- */
  /* ----- Reports view charts (rendered lazily on first show) ----- */
  window.__renderReports = function () {
    renderDonut('repChartA', [{"label": "Anthropic", "value": 62, "color": "var(--accent)"}, {"label": "Internal", "value": 38, "color": "var(--accent-2)"}]);
    renderBars('repChartB', [{"label": "router", "value": 1.88}, {"label": "embed", "value": 2.44}, {"label": "haiku", "value": 1.2}, {"label": "guard", "value": 0.99}, {"label": "mod", "value": 0.74}, {"label": "sonnet", "value": 0.61}], {"prefix": "", "suffix": "M"});
  ...
  (function () {
    ...
    var KEY = 'template-19-ai-usage-dashboard-theme';
  ...
  attachDonutTip(qs('#modelDonut'), function () { return MODELSHARE; }, function (s) { return s.value + 'M tokens'; });
  ...
  function applyRange(k) {
    renderBars('tokenBars', k === 'b' ? TOKENS.slice(7) : TOKENS, {"suffix": "M", "tips": false});
  }
