# Tokentrace — AI Usage Dashboard Template

A neon-on-dark AI usage dashboard template with grouped token bar chart, model-share donut, top consumers list, model table and light theme toggle.
...
- Token usage — 14 days (bars chart)
- Usage by model (donut chart)
- Model fleet — data table with 8 realistic rows, status pills and row actions
- Platform timeline — timestamped feed
- Top consumers (top items list)
...
- **Models** (`#/list`) — a searchable, paginated, CSV-exportable table of 20 models.
- **Usage reports** (`#/reports`) — two extra charts, three insight tiles and key takeaways.
