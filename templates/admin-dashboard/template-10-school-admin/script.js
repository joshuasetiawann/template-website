/* Campusgrove — school admin dashboard interactions (vanilla JS, no dependencies) */
(function () {
  'use strict';
  var doc = document;
  var body = doc.body;
  ...
  /* ----- Chart data (Campusgrove sample dataset) ----- */
  var ATTEND = [{"name": "Attendance", "color": "#16A34A", "area": true, "dots": true, "data": [91.2, 92.6, 93.1, 92.2, 94.0, 93.4, 94.8, 94.1, 95.0, 94.6]}];
  var ATTENDLabels = ["Wk 1", "Wk 2", "Wk 3", "Wk 4", "Wk 5", "Wk 6", "Wk 7", "Wk 8", "Wk 9", "Wk 10"];
  function drawATTEND(skip) {
    renderLine('attendLine', ATTEND, { labels: ATTENDLabels, skipAnim: skip, fmtY: function (v) { return v + '%'; } });
  }
  drawATTEND(false);
  redraws.push(function () { drawATTEND(true); });


  /* ----- Campusgrove release upgrades: year, shimmer, reveal, pagination, export, tooltips ----- */
  /* ----- Reports view charts (rendered lazily on first show) ----- */
  window.__renderReports = function () {
    renderLine('repChartA', [{"name": "Attendance", "color": "var(--accent)", "area": true, "dots": true, "data": [88, 90, 89, 91, 92, 93, 92, 94]}], { labels: ["W1", "W2", "W3", "W4", "W5", "W6", "W7", "W8"], fmtY: function (v) { return v + '%'; } });
    renderLine('repChartB', [{"name": "GPA", "color": "var(--accent-2)", "area": true, "dots": true, "data": [3.1, 3.2, 3.3, 3.6]}], { labels: ["Yr 9", "Yr 10", "Yr 11", "Yr 12"], fmtY: function (v) { return '' + v; } });
  ...
  var ATTEND_A = ATTEND;
  var ATTEND_B = [{"name": "Attendance", "color": "#16A34A", "area": true, "dots": true, "data": [90.4, 91.8, 92.2, 91.5, 93.1, 92.6, 93.8, 93.2, 94.1, 93.7]}];
  function applyRange(k) {
    ATTEND = k === 'b' ? ATTEND_B : ATTEND_A;
    drawATTEND(false);
  }
