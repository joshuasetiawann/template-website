# Campusgrove — School Admin Dashboard Template

A two-tone school administration dashboard template with green sidebar, attendance line chart, term calendar, staff strip and tabbed student table.
...
- Attendance rate — Summer term (line chart)
- Student register — data table with 7 realistic rows, status pills and row actions
- School log — timestamped feed
- Term calendar (mini calendar grid)
- On-duty staff today (team avatar row)
...
- **Students** (`#/list`) — a searchable, paginated, CSV-exportable table of 20 students.
- **Academic reports** (`#/reports`) — two extra charts, three insight tiles and key takeaways.
