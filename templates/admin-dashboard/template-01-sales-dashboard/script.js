/* Northpeak — sales dashboard interactions (vanilla JS, no dependencies) */
(function () {
  'use strict';
  var doc = document;
  var body = doc.body;
  ...
  /* ----- Chart data (Northpeak sample dataset) ----- */
  var REVENUE = {"6 mo": [{"label": "Jan", "value": 186}, {"label": "Feb", "value": 204}, {"label": "Mar", "value": 178}, {"label": "Apr", "value": 231}, {"label": "May", "value": 262}, {"label": "Jun", "value": 284}], "12 mo": [{"label": "Jul", "value": 142}, {"label": "Aug", "value": 151}, {"label": "Sep", "value": 168}, {"label": "Oct", "value": 174}, {"label": "Nov", "value": 197}, {"label": "Dec", "value": 210}, {"label": "Jan", "value": 186}, {"label": "Feb", "value": 204}, {"label": "Mar", "value": 178}, {"label": "Apr", "value": 231}, {"label": "May", "value": 262}, {"label": "Jun", "value": 284}]};
  var REVENUEOpts = {"prefix": "$", "suffix": "k"};
  renderBars('revChart', REVENUE['6 mo'], REVENUEOpts);
  qsa('.range-chips button').forEach(function (btn) {
    btn.addEventListener('click', function () {
      qsa('.range-chips button').forEach(function (b) { b.setAttribute('aria-pressed', String(b === btn)); });
      var set = REVENUE[btn.getAttribute('data-range')];
      if (set) renderBars('revChart', set, REVENUEOpts);
    });
  });


  /* ----- Northpeak release upgrades: year, shimmer, reveal, pagination, export, tooltips ----- */
  /* ----- Reports view charts (rendered lazily on first show) ----- */
  window.__renderReports = function () {
    renderBars('repChartA', [{"label": "Jan", "value": 9}, {"label": "Feb", "value": 12}, {"label": "Mar", "value": 8}, {"label": "Apr", "value": 14}, {"label": "May", "value": 16}, {"label": "Jun", "value": 18}], {"prefix": "", "suffix": ""});
    renderBars('repChartB', [{"label": "Disc", "value": 312}, {"label": "Prop", "value": 248}, {"label": "Neg", "value": 196}, {"label": "Won", "value": 268}, {"label": "Lost", "value": 71}], {"prefix": "$", "suffix": "k"});
