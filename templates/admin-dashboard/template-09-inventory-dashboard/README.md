# Stockpilot — Inventory Dashboard Template

A warm-gray dense inventory dashboard template with icon-rail navigation, stock movement combo chart, warehouse capacity bars and reorder queue table.
...
- Stock movement — 12 weeks (combo chart)
- Reorder queue — data table with 9 realistic rows, status pills and row actions
- Warehouse log — timestamped feed
- Warehouse capacity (progress list)
...
- **Stock** (`#/list`) — a searchable, paginated, CSV-exportable table of 20 SKUs.
- **Inventory reports** (`#/reports`) — two extra charts, three insight tiles and key takeaways.
