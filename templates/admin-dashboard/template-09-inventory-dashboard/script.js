/* Stockpilot — inventory dashboard interactions (vanilla JS, no dependencies) */
(function () {
  'use strict';
  var doc = document;
  var body = doc.body;
  ...
  function renderCombo(holderId, data, opts) {
    ...
    data.forEach(function (d) {
      ...
      (d.bars || []).forEach(function (v, i) {
        ...
        b.setAttribute('title', d.label + ' \u00b7 ' + (i === 0 ? 'Received' : 'Shipped') + ': ' + v);
        col.appendChild(b);
        bars.push(b);
      });
  ...
  /* ----- Chart data (Stockpilot sample dataset) ----- */
  var MOVEMENT = [{"label": "W14", "bars": [320, 290], "line": 190}, {"label": "W15", "bars": [280, 310], "line": 130}, {"label": "W16", "bars": [410, 350], "line": 220}, {"label": "W17", "bars": [360, 380], "line": 140}, {"label": "W18", "bars": [390, 360], "line": 190}, {"label": "W19", "bars": [340, 370], "line": 130}, {"label": "W20", "bars": [450, 400], "line": 210}, {"label": "W21", "bars": [430, 440], "line": 150}, {"label": "W22", "bars": [470, 430], "line": 200}, {"label": "W23", "bars": [420, 460], "line": 120}, {"label": "W24", "bars": [510, 470], "line": 200}, {"label": "W25", "bars": [480, 500], "line": 140}];
  function drawMOVEMENT(skip) {
    renderCombo('stockCombo', MOVEMENT, { lineColor: '#2563EB', skipAnim: skip });
  }
  drawMOVEMENT(false);
  redraws.push(function () { drawMOVEMENT(true); });


  /* ----- Stockpilot release upgrades: year, shimmer, reveal, pagination, export, tooltips ----- */
  /* ----- Reports view charts (rendered lazily on first show) ----- */
  window.__renderReports = function () {
    renderCombo('repChartA', [{"label": "W1", "bars": [820, 640], "line": 180}, {"label": "W2", "bars": [760, 720], "line": 40}, {"label": "W3", "bars": [910, 680], "line": 230}, {"label": "W4", "bars": [840, 790], "line": 50}, {"label": "W5", "bars": [980, 720], "line": 260}, {"label": "W6", "bars": [900, 860], "line": 40}], { lineColor: 'var(--accent-2)' });
    renderCombo('repChartB', [{"label": "Rotterdam", "bars": [1248, 0], "line": 1248}, {"label": "Hamburg", "bars": [720, 0], "line": 720}, {"label": "Lyon", "bars": [432, 0], "line": 432}], { lineColor: 'var(--accent-2)' });
  ...
  var MOVEMENT_A = MOVEMENT;
  function applyRange(k) {
    MOVEMENT = k === 'b' ? MOVEMENT_A.slice(6) : MOVEMENT_A;
    drawMOVEMENT(false);
  }
