/* Inkflow — content dashboard interactions (vanilla JS, no dependencies) */
(function () {
  'use strict';
  var doc = document;
  var body = doc.body;
  ...
  /* ----- Chart data (Inkflow sample dataset) ----- */
  var STAGES = [{"label": "Idea backlog", "value": 24}, {"label": "Drafting", "value": 16}, {"label": "In review", "value": 9}, {"label": "Scheduled", "value": 14}, {"label": "Published MTD", "value": 42}];
  renderHBars('stageBars', STAGES, {});


  /* ----- Inkflow release upgrades: year, shimmer, reveal, pagination, export, tooltips ----- */
  /* ----- Reports view charts (rendered lazily on first show) ----- */
  window.__renderReports = function () {
    renderHBars('repChartA', [{"label": "Growth", "value": 70, "display": "70k"}, {"label": "Product", "value": 44, "display": "44k"}, {"label": "Stories", "value": 30, "display": "30k"}, {"label": "Research", "value": 22, "display": "22k"}, {"label": "Guides", "value": 18, "display": "18k"}], {"prefix": "", "suffix": ""});
    renderHBars('repChartB', [{"label": "Published", "value": 42}, {"label": "Draft", "value": 8}, {"label": "In review", "value": 6}, {"label": "Scheduled", "value": 4}], {"prefix": "", "suffix": ""});
  ...
  var STAGES_B = [{"label": "Idea backlog", "value": 21}, {"label": "Drafting", "value": 13}, {"label": "In review", "value": 11}, {"label": "Scheduled", "value": 12}, {"label": "Published MTD", "value": 38}];
  function applyRange(k) {
    renderHBars('stageBars', k === 'b' ? STAGES_B : STAGES, {});
  }
