# Hearthview — Real Estate Admin Dashboard Template

A warm sand-toned real estate admin dashboard template with serif headings, viewings bar chart, hottest listings ranking and a filterable listings table.
...
- Viewings per week (bars chart)
- Listing portfolio — data table with 7 realistic rows, status pills and row actions
- Agency activity — timestamped feed
- Hottest listings (top items list)
...
- **Listings** (`#/list`) — a searchable, paginated, CSV-exportable table of 20 listings.
- **Agency reports** (`#/reports`) — two extra charts, three insight tiles and key takeaways.
