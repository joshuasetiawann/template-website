/* Hearthview — real estate admin dashboard interactions (vanilla JS, no dependencies) */
(function () {
  'use strict';
  var doc = document;
  var body = doc.body;
  ...
  /* ----- Chart data (Hearthview sample dataset) ----- */
  var VIEWINGS = [{"label": "Apr 20", "value": 52}, {"label": "Apr 27", "value": 58}, {"label": "May 4", "value": 49}, {"label": "May 11", "value": 64}, {"label": "May 18", "value": 71}, {"label": "May 25", "value": 66}, {"label": "Jun 1", "value": 78}, {"label": "Jun 8", "value": 86}];
  renderBars('viewBars', VIEWINGS, {"suffix": ""});


  /* ----- Hearthview release upgrades: year, shimmer, reveal, pagination, export, tooltips ----- */
  /* ----- Reports view charts (rendered lazily on first show) ----- */
  window.__renderReports = function () {
    renderBars('repChartA', [{"label": "Jan", "value": 18}, {"label": "Feb", "value": 21}, {"label": "Mar", "value": 19}, {"label": "Apr", "value": 24}, {"label": "May", "value": 23}, {"label": "Jun", "value": 28}], {"prefix": "", "suffix": ""});
    renderBars('repChartB', [{"label": "Studio", "value": 240}, {"label": "Apartment", "value": 380}, {"label": "House", "value": 560}, {"label": "Commercial", "value": 1320}], {"prefix": "$", "suffix": "k"});
  ...
  function applyRange(k) {
    renderBars('viewBars', k === 'b' ? VIEWINGS.slice(4) : VIEWINGS, {"suffix": ""});
  }
