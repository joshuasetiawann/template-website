# Fanforge — Creator Dashboard Template

A plum-dark creator studio dashboard template with earnings bar chart, revenue-mix donut, collab strip, content table and light theme toggle.
...
- Earnings by month (bars chart)
- Revenue mix — June (donut chart)
- Latest content — data table with 7 realistic rows, status pills and row actions
- Studio timeline — timestamped feed
- Quick actions (quick actions grid)
- Collab partners (team avatar row)
...
- **Content** (`#/list`) — a searchable, paginated, CSV-exportable table of 20 posts.
- **Studio reports** (`#/reports`) — two extra charts, three insight tiles and key takeaways.
