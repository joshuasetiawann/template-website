/* Fanforge — creator dashboard interactions (vanilla JS, no dependencies) */
(function () {
  'use strict';
  var doc = document;
  var body = doc.body;
  ...
  if (themeBtn) {
    ...
    var THEME_KEY = 'template-20-creator-dashboard-theme';
    try {
  ...
  /* ----- Chart data (Fanforge sample dataset) ----- */
  var EARNINGS = [{"label": "Nov", "value": 7.4}, {"label": "Dec", "value": 9.1}, {"label": "Jan", "value": 6.8}, {"label": "Feb", "value": 7.9}, {"label": "Mar", "value": 8.6}, {"label": "Apr", "value": 9.8}, {"label": "May", "value": 11.2}, {"label": "Jun", "value": 12.8}];
  renderBars('earnBars', EARNINGS, {"prefix": "$", "suffix": "k"});
  var MIX = [{"label": "Memberships", "value": 5.6, "color": "#EC4899"}, {"label": "Sponsorships", "value": 3.9, "color": "#F59E0B"}, {"label": "Ad revenue", "value": 2.1, "color": "#A78BFA"}, {"label": "Tips", "value": 1.2, "color": "#34D08C"}];
  renderDonut('mixDonut', MIX);


  /* ----- Fanforge release upgrades: year, shimmer, reveal, pagination, export, tooltips ----- */
  /* ----- Reports view charts (rendered lazily on first show) ----- */
  window.__renderReports = function () {
    renderBars('repChartA', [{"label": "TikTok", "value": 1296}, {"label": "YouTube", "value": 624}, {"label": "Instagram", "value": 360}, {"label": "Email", "value": 84}, {"label": "Patreon", "value": 36}], {"prefix": "", "suffix": "k"});
    renderDonut('repChartB', [{"label": "Memberships", "value": 42, "color": "var(--accent)"}, {"label": "Sponsorships", "value": 34, "color": "var(--accent-2)"}, {"label": "Ad revenue", "value": 18, "color": "#FBBF24"}, {"label": "Tips", "value": 6, "color": "#34D399"}]);
  ...
  (function () {
    ...
    var KEY = 'template-20-creator-dashboard-theme';
  ...
  attachDonutTip(qs('#mixDonut'), function () { return MIX; }, function (s) { return '$' + s.value + 'k'; });
  ...
  function applyRange(k) {
    renderBars('earnBars', k === 'b' ? EARNINGS.slice(4) : EARNINGS, {"prefix": "$", "suffix": "k"});
  }
