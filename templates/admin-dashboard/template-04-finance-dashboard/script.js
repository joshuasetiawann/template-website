/* Ledgerline — finance dashboard interactions (vanilla JS, no dependencies) */
(function () {
  'use strict';
  var doc = document;
  var body = doc.body;
  ...
  function renderCombo(holderId, data, opts) {
    ...
    data.forEach(function (d) {
      ...
      (d.bars || []).forEach(function (v, i) {
        ...
        b.setAttribute('title', d.label + ' \u00b7 ' + (i === 0 ? 'Inflow' : 'Outflow') + ': ' + v);
        col.appendChild(b);
        bars.push(b);
      });
  ...
  /* ----- Chart data (Ledgerline sample dataset) ----- */
  var CASH = [{"label": "W14", "bars": [62, 48], "line": 44}, {"label": "W15", "bars": [58, 51], "line": 37}, {"label": "W16", "bars": [71, 47], "line": 54}, {"label": "W17", "bars": [66, 59], "line": 37}, {"label": "W18", "bars": [74, 55], "line": 49}, {"label": "W19", "bars": [69, 62], "line": 37}, {"label": "W20", "bars": [80, 58], "line": 52}, {"label": "W21", "bars": [76, 66], "line": 40}, {"label": "W22", "bars": [83, 61], "line": 52}, {"label": "W23", "bars": [78, 70], "line": 38}, {"label": "W24", "bars": [88, 64], "line": 54}, {"label": "W25", "bars": [92, 71], "line": 51}];
  function drawCASH(skip) {
    renderCombo('cashCombo', CASH, { lineColor: '#16A34A', skipAnim: skip });
  }
  drawCASH(false);
  redraws.push(function () { drawCASH(true); });


  /* ----- Ledgerline release upgrades: year, shimmer, reveal, pagination, export, tooltips ----- */
  /* ----- Reports view charts (rendered lazily on first show) ----- */
  window.__renderReports = function () {
    renderCombo('repChartA', [{"label": "Jan", "bars": [380, 320], "line": 60}, {"label": "Feb", "bars": [410, 360], "line": 50}, {"label": "Mar", "bars": [395, 348], "line": 47}, {"label": "Apr", "bars": [452, 366], "line": 86}, {"label": "May", "bars": [468, 372], "line": 96}, {"label": "Jun", "bars": [452, 238], "line": 214}], { lineColor: '#16A34A' });
    renderCombo('repChartB', [{"label": "Payroll", "bars": [184, 0], "line": 190}, {"label": "Cloud", "bars": [50, 0], "line": 48}, {"label": "Lease", "bars": [14, 0], "line": 14}, {"label": "Tax", "bars": [63, 0], "line": 60}, {"label": "Ads", "bars": [18, 0], "line": 20}, {"label": "Other", "bars": [22, 0], "line": 24}], { lineColor: 'var(--accent-2)' });
  ...
  function applyRange(k) {
    CASH = k === 'b' ? CASH_A.slice(6) : CASH_A;
    drawCASH(false);
  }
