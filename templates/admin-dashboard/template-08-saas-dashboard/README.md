# Orbitly — SaaS Dashboard Template

A glowing dark SaaS metrics dashboard template with bento tiles, MRR bar chart, plan-mix donut, ARR goal gauge and a light theme toggle.
...
- Net MRR movement (bars chart)
- MRR by plan (donut chart)
- Top accounts — data table with 7 realistic rows, status pills and row actions
- Revenue timeline — timestamped feed
- Q2 ARR goal (goal gauge)
...
- **Accounts** (`#/list`) — a searchable, paginated, CSV-exportable table of 20 accounts.
- **Revenue reports** (`#/reports`) — two extra charts, three insight tiles and key takeaways.
