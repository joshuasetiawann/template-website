/* Clubrise — membership dashboard interactions (vanilla JS, no dependencies) */
(function () {
  'use strict';
  var doc = document;
  var body = doc.body;
  ...
  /* ----- Chart data (Clubrise sample dataset) ----- */
  var COHORT = [{"label": "Active", "value": 3482, "color": "#E11D48"}, {"label": "At-risk", "value": 412, "color": "#E8A33D"}, {"label": "Paused", "value": 186, "color": "#8A7570"}, {"label": "Churned", "value": 238, "color": "#FB7185"}];
  renderDonut('churnDonut', COHORT);
  renderGauge('renewGauge', 0.68, function (p) { return Math.round(68 * p) + '%'; });


  /* ----- Clubrise release upgrades: year, shimmer, reveal, pagination, export, tooltips ----- */
  /* ----- Reports view charts (rendered lazily on first show) ----- */
  window.__renderReports = function () {
    renderDonut('repChartA', [{"label": "Standard", "value": 48, "color": "var(--accent)"}, {"label": "Premium", "value": 32, "color": "var(--accent-2)"}, {"label": "Family", "value": 20, "color": "#FB7185"}]);
    renderGauge('repChartB', 0.88, function (p) { return Math.round(88 * p) + '%'; });
  ...
  attachDonutTip(qs('#churnDonut'), function () { return cohortNow; }, function (s) { return s.value.toLocaleString('en-US') + ' members'; });
  ...
  var COHORT_A = COHORT;
  var COHORT_B = [{"label": "Active", "value": 3398, "color": "#E11D48"}, {"label": "At-risk", "value": 386, "color": "#E8A33D"}, {"label": "Paused", "value": 201, "color": "#8A7570"}, {"label": "Churned", "value": 264, "color": "#FB7185"}];
  var CO_LEG = { a: { lv: ["3,482", "412", "186", "238"], lp: ["81%", "9%", "4%", "6%"], c: "91.4%" },
                 b: { lv: ["3,398", "386", "201", "264"], lp: ["80%", "9%", "5%", "6%"], c: "90.6%" } };
  var cohortNow = COHORT;
  function applyRange(k) {
    cohortNow = k === 'b' ? COHORT_B : COHORT_A;
    renderDonut('churnDonut', cohortNow);
    var leg = CO_LEG[k] || CO_LEG.a;
