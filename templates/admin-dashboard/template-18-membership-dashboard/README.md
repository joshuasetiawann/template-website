# Clubrise — Membership Dashboard Template

A peach-toned membership dashboard template with churn donut, renewal goal gauge, filterable member table and retention activity feed.
...
- Member directory — data table with 7 realistic rows, status pills and row actions
- Retention feed — timestamped feed
- June renewal goal (goal gauge)
...
- **Members** (`#/list`) — a searchable, paginated, CSV-exportable table of 20 members.
- **Membership reports** (`#/reports`) — two extra charts, three insight tiles and key takeaways.
