/* Pipeforge — crm dashboard interactions (vanilla JS, no dependencies) */
(function () {
  'use strict';
  var doc = document;
  var body = doc.body;
  ...
  if (themeBtn) {
    ...
    var THEME_KEY = 'template-03-crm-dashboard-theme';
    try {
  ...
  /* ----- Chart data (Pipeforge sample dataset) ----- */
  var PIPE = [{"label": "Nov", "value": 310}, {"label": "Dec", "value": 248}, {"label": "Jan", "value": 356}, {"label": "Feb", "value": 402}, {"label": "Mar", "value": 374}, {"label": "Apr", "value": 441}, {"label": "May", "value": 489}, {"label": "Jun", "value": 522}];
  renderBars('pipeBars', PIPE, {"prefix": "$", "suffix": "k"});
  var STAGES = [{"label": "Discovery", "value": 92, "color": "#22D3EE"}, {"label": "Evaluation", "value": 78, "color": "#818CF8"}, {"label": "Proposal", "value": 66, "color": "#34D08C"}, {"label": "Commit", "value": 48, "color": "#E8A33D"}];
  renderDonut('stageDonut', STAGES);


  /* ----- Pipeforge release upgrades: year, shimmer, reveal, pagination, export, tooltips ----- */
  /* ----- Reports view charts (rendered lazily on first show) ----- */
  window.__renderReports = function () {
    renderDonut('repChartA', [{"label": "Webinar", "value": 38, "color": "var(--accent)"}, {"label": "Referral", "value": 24, "color": "var(--accent-2)"}, {"label": "Website", "value": 18, "color": "#A78BFA"}, {"label": "Cold call", "value": 12, "color": "#F472B6"}, {"label": "Ads", "value": 8, "color": "#FBBF24"}]);
    renderBars('repChartB', [{"label": "New", "value": 146}, {"label": "Cont.", "value": 98}, {"label": "Qual.", "value": 60}, {"label": "Meet", "value": 32}, {"label": "Won", "value": 14}], {"prefix": "", "suffix": ""});
  ...
  (function () {
    ...
    var KEY = 'template-03-crm-dashboard-theme';
  ...
  attachDonutTip(qs('#stageDonut'), function () { return STAGES; }, function (s) { return s.value + ' deals'; });
  ...
  function applyRange(k) {
    renderBars('pipeBars', k === 'b' ? PIPE.slice(2) : PIPE, {"prefix": "$", "suffix": "k"});
  }
