# Peoplewise — HR Dashboard Template

A friendly light HR dashboard template with headcount stats, an animated department bar chart, hiring funnel progress list and candidate table.

Part of a 100-template library of pure HTML/CSS/JS website templates. This template uses the classic light layout with a right-hand activity column.
...
- Headcount by department (hbars chart)
- Active candidates — data table with 7 realistic rows, status pills and row actions
- People activity — timestamped feed
- Hiring funnel (progress list)
- Starting this week (team avatar row)
...
- **Employees** (`#/list`) — a searchable, paginated, CSV-exportable table of 20 employees.
- **People reports** (`#/reports`) — two extra charts, three insight tiles and key takeaways.
