/* Peoplewise — hr dashboard interactions (vanilla JS, no dependencies) */
(function () {
  'use strict';
  var doc = document;
  var body = doc.body;
  ...
  function renderHBars(holderId, data, opts) {
    var holder = doc.getElementById(holderId);
    if (!holder) return;
    opts = opts || {};
    var max = opts.max || 0;
    if (!max) data.forEach(function (d) { if (d.value > max) max = d.value; });
    holder.innerHTML = '';
    var fills = [];
    data.forEach(function (d) {
      ...
      fill.setAttribute('data-w', String(Math.round(d.value / max * 100)));
      track.appendChild(fill);
      var val = el('span', 'val');
      val.textContent = (opts.prefix || '') + (d.display != null ? d.display : d.value) + (opts.suffix || '');
      row.appendChild(lbl);
  ...
  /* ----- Chart data (Peoplewise sample dataset) ----- */
  var DEPTS = [{"label": "Engineering", "value": 124}, {"label": "Sales", "value": 86}, {"label": "Support", "value": 64}, {"label": "Marketing", "value": 38}, {"label": "Finance", "value": 27}, {"label": "People Ops", "value": 19}];
  renderHBars('deptBars', DEPTS, {});


  /* ----- Peoplewise release upgrades: year, shimmer, reveal, pagination, export, tooltips ----- */
  /* ----- Reports view charts (rendered lazily on first show) ----- */
  window.__renderReports = function () {
    renderHBars('repChartA', [{"label": "Engineering", "value": 86}, {"label": "Sales", "value": 42}, {"label": "Support", "value": 34}, {"label": "Product", "value": 28}, {"label": "Design", "value": 22}, {"label": "Marketing", "value": 18}, {"label": "Finance", "value": 10}, {"label": "People", "value": 8}], {"prefix": "", "suffix": ""});
    renderHBars('repChartB', [{"label": "0\u20131 yr", "value": 14, "display": "14%"}, {"label": "1\u20132 yrs", "value": 9, "display": "9%"}, {"label": "2\u20134 yrs", "value": 6, "display": "6%"}, {"label": "4\u20136 yrs", "value": 4, "display": "4%"}, {"label": "6+ yrs", "value": 3, "display": "3%"}], {"prefix": "", "suffix": ""});
  ...
  var DEPTS_B = [{"label": "Engineering", "value": 112}, {"label": "Sales", "value": 79}, {"label": "Support", "value": 58}, {"label": "Marketing", "value": 33}, {"label": "Finance", "value": 24}, {"label": "People Ops", "value": 15}];
  function applyRange(k) {
    renderHBars('deptBars', k === 'b' ? DEPTS_B : DEPTS, {});
  }
