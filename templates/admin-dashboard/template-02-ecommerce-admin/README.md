# Cartloom — E-commerce Admin Dashboard Template

A two-tone e-commerce admin dashboard template with an indigo sidebar, animated revenue line chart, tabbed orders table and best-seller list.
...
- Orders — data table with 7 realistic rows, status pills and row actions
- Store activity — timestamped feed
- Best sellers (top items list)
...
- **Orders** (`#/list`) — a searchable, paginated, CSV-exportable table of 20 orders.
- **Store reports** (`#/reports`) — two extra charts, three insight tiles and key takeaways.
