# Stayline — Booking Dashboard Template

A fresh teal booking dashboard template with daily occupancy bars and target line, June availability calendar and a reservations table.
...
- Occupancy — next 10 nights (bars chart)
- Arrivals & reservations — data table with 7 realistic rows, status pills and row actions
- Front-desk feed — timestamped feed
- June availability (mini calendar grid)
...
- **Reservations** (`#/list`) — a searchable, paginated, CSV-exportable table of 20 reservations.
- **Property reports** (`#/reports`) — two extra charts, three insight tiles and key takeaways.
