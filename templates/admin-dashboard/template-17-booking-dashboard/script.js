/* Stayline — booking dashboard interactions (vanilla JS, no dependencies) */
(function () {
  'use strict';
  var doc = document;
  var body = doc.body;
  ...
  /* ----- Chart data (Stayline sample dataset) ----- */
  var OCCUPANCY = [{"label": "Thu 11", "value": 84}, {"label": "Fri 12", "value": 91}, {"label": "Sat 13", "value": 96}, {"label": "Sun 14", "value": 72}, {"label": "Mon 15", "value": 64}, {"label": "Tue 16", "value": 69}, {"label": "Wed 17", "value": 75}, {"label": "Thu 18", "value": 83}, {"label": "Fri 19", "value": 99}, {"label": "Sat 20", "value": 100}];
  renderBars('occBars', OCCUPANCY, {"suffix": "%", "max": 100});


  /* ----- Stayline release upgrades: year, shimmer, reveal, pagination, export, tooltips ----- */
  /* ----- Reports view charts (rendered lazily on first show) ----- */
  window.__renderReports = function () {
    renderBars('repChartA', [{"label": "W1", "value": 76}, {"label": "W2", "value": 79}, {"label": "W3", "value": 82}, {"label": "W4", "value": 80}, {"label": "W5", "value": 85}, {"label": "W6", "value": 88}], {"prefix": "", "suffix": "%"});
    renderBars('repChartB', [{"label": "Direct", "value": 142}, {"label": "Booking", "value": 98}, {"label": "Expedia", "value": 64}, {"label": "Airbnb", "value": 38}, {"label": "Phone", "value": 26}], {"prefix": "", "suffix": ""});
  ...
  var OCC_B = [{"label": "Jun 1", "value": 76}, {"label": "Jun 2", "value": 88}, {"label": "Jun 3", "value": 93}, {"label": "Jun 4", "value": 68}, {"label": "Jun 5", "value": 57}, {"label": "Jun 6", "value": 61}, {"label": "Jun 7", "value": 70}, {"label": "Jun 8", "value": 79}, {"label": "Jun 9", "value": 95}, {"label": "Jun 10", "value": 98}];
  function applyRange(k) {
    renderBars('occBars', k === 'b' ? OCC_B : OCCUPANCY, {"suffix": "%", "max": 100});
  }
