# ClimaCore HVAC — HVAC Template

ClimaCore HVAC is a complete, four-page hvac website template — a trusted-trade design with a full services listing, an interactive quote/booking widget, transparent pricing and a validated contact flow, all in pure HTML, CSS and vanilla JavaScript.
...
- `services.html` — the primary page: breadcrumb, hero, the full HVAC services listing (AC Repair & Tune-Up, Furnace & Heating Service, System Installation & Replacement and more), a free-quote booking widget, service-area band, an `#pricing` section, guarantees, why-us and an FAQ accordion
