# ShieldPest Control — Pest Control Template

ShieldPest Control is a complete, four-page pest control website template — a bold-urgent design with a full services listing, an interactive quote/booking widget, transparent pricing and a validated contact flow, all in pure HTML, CSS and vanilla JavaScript.
...
- `services.html` — the primary page: breadcrumb, hero, the full Pest Control services listing (General Pest Control, Rodent Control & Exclusion, Termite Inspection & Treatment and more), a free-quote booking widget, service-area band, an `#pricing` section, guarantees, why-us and an FAQ accordion
