# DrainGuard Plumbing — Plumber Template

DrainGuard Plumbing is a complete, four-page plumber website template — a bold-urgent design with a full services listing, an interactive quote/booking widget, transparent pricing and a validated contact flow, all in pure HTML, CSS and vanilla JavaScript.

## Features

- Layout variant: **V5 (bold-urgent)** — pure HTML5 / CSS3 / vanilla JavaScript, with no frameworks, web fonts, icon libraries or external images
...
- `services.html` — the primary page: breadcrumb, hero, the full Plumber services listing (Emergency Leak & Burst Pipe Repair, Drain Cleaning & Hydro-Jetting, Water Heater Repair & Install and more), a free-quote booking widget, service-area band, an `#pricing` section, guarantees, why-us and an FAQ accordion
