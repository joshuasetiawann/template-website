# TrueHue Painting — Painting Template

TrueHue Painting is a complete, four-page painting website template — a clean-modern design with a full services listing, an interactive quote/booking widget, transparent pricing and a validated contact flow, all in pure HTML, CSS and vanilla JavaScript.
...
- `services.html` — the primary page: breadcrumb, hero, the full Painting services listing (Interior Painting, Exterior Painting, Cabinet Refinishing and more), a free-quote booking widget, service-area band, an `#pricing` section, guarantees, why-us and an FAQ accordion
