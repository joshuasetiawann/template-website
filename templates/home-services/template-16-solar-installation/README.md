# SunCrest Solar — Solar Installation Template

SunCrest Solar is a complete, four-page solar installation website template — a premium-home design with a full services listing, an interactive quote/booking widget, transparent pricing and a validated contact flow, all in pure HTML, CSS and vanilla JavaScript.
...
- `services.html` — the primary page: breadcrumb, hero, the full Solar Installation services listing (Solar Panel Installation, Battery Storage, Energy Consultation & Design and more), a free-quote booking widget, service-area band, an `#pricing` section, guarantees, why-us and an FAQ accordion
