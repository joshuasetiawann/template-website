# IronOak Fencing — Fencing Template

IronOak Fencing is a complete, four-page fencing website template — a trusted-trade design with a full services listing, an interactive quote/booking widget, transparent pricing and a validated contact flow, all in pure HTML, CSS and vanilla JavaScript.
...
- `services.html` — the primary page: breadcrumb, hero, the full Fencing services listing (Wood Fence Installation, Vinyl & PVC Fencing, Aluminum & Ornamental and more), a free-quote booking widget, service-area band, an `#pricing` section, guarantees, why-us and an FAQ accordion
