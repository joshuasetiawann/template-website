# SummitPeak Roofing — Roofing Template

SummitPeak Roofing is a complete, four-page roofing website template — a trusted-trade design with a full services listing, an interactive quote/booking widget, transparent pricing and a validated contact flow, all in pure HTML, CSS and vanilla JavaScript.
...
- `services.html` — the primary page: breadcrumb, hero, the full Roofing services listing (Roof Repair & Leak Fix, Full Roof Replacement, Storm & Hail Damage and more), a free-quote booking widget, service-area band, an `#pricing` section, guarantees, why-us and an FAQ accordion
