# ClearView Window Cleaning — Window Cleaning Template

ClearView Window Cleaning is a complete, four-page window cleaning website template — a eco-fresh design with a full services listing, an interactive quote/booking widget, transparent pricing and a validated contact flow, all in pure HTML, CSS and vanilla JavaScript.

## Features

- Layout variant: **V4 (eco-fresh)** — pure HTML5 / CSS3 / vanilla JavaScript, with no frameworks, web fonts, icon libraries or external images
...
- `services.html` — the primary page: breadcrumb, hero, the full Window Cleaning services listing (Residential Window Cleaning, Exterior-Only Cleaning, Screen & Track Detailing and more), a free-quote booking widget, service-area band, an `#pricing` section, guarantees, why-us and an FAQ accordion
