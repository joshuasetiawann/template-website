# AquaLux Pool Service — Pool Service Template

AquaLux Pool Service is a complete, four-page pool service website template — a eco-fresh design with a full services listing, an interactive quote/booking widget, transparent pricing and a validated contact flow, all in pure HTML, CSS and vanilla JavaScript.
...
- `services.html` — the primary page: breadcrumb, hero, the full Pool Service services listing (Weekly Pool Maintenance, Pool Cleaning & Balancing, Equipment Repair & Install and more), a free-quote booking widget, service-area band, an `#pricing` section, guarantees, why-us and an FAQ accordion
