# FixWell Handyman — Handyman Template

FixWell Handyman is a complete, four-page handyman website template — a clean-modern design with a full services listing, an interactive quote/booking widget, transparent pricing and a validated contact flow, all in pure HTML, CSS and vanilla JavaScript.
...
- `services.html` — the primary page: breadcrumb, hero, the full Handyman services listing (General Home Repairs, TV & Furniture Mounting, Plumbing & Fixture Swaps and more), a free-quote booking widget, service-area band, an `#pricing` section, guarantees, why-us and an FAQ accordion
