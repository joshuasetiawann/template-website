# GreenHaven Landscapes — Landscaping Template

GreenHaven Landscapes is a complete, four-page landscaping website template — a eco-fresh design with a full services listing, an interactive quote/booking widget, transparent pricing and a validated contact flow, all in pure HTML, CSS and vanilla JavaScript.
...
- `services.html` — the primary page: breadcrumb, hero, the full Landscaping services listing (Lawn Care & Maintenance, Landscape Design & Build, Hardscaping & Patios and more), a free-quote booking widget, service-area band, an `#pricing` section, guarantees, why-us and an FAQ accordion
