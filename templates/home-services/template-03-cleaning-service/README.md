# FreshNest Cleaning — Cleaning Service Template

FreshNest Cleaning is a complete, four-page cleaning service website template — a eco-fresh design with a full services listing, an interactive quote/booking widget, transparent pricing and a validated contact flow, all in pure HTML, CSS and vanilla JavaScript.
...
- `services.html` — the primary page: breadcrumb, hero, the full Cleaning Service services listing (Recurring Home Cleaning, Deep Clean, Move-In / Move-Out Clean and more), a free-quote booking widget, service-area band, an `#pricing` section, guarantees, why-us and an FAQ accordion
