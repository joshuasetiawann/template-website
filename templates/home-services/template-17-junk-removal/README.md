# HaulAway Junk Removal — Junk Removal Template

HaulAway Junk Removal is a complete, four-page junk removal website template — a clean-modern design with a full services listing, an interactive quote/booking widget, transparent pricing and a validated contact flow, all in pure HTML, CSS and vanilla JavaScript.

## Features

- Layout variant: **V2 (clean-modern)** — pure HTML5 / CSS3 / vanilla JavaScript, with no frameworks, web fonts, icon libraries or external images
...
- `services.html` — the primary page: breadcrumb, hero, the full Junk Removal services listing (Furniture & Appliance Removal, Full-Home & Estate Cleanout, Garage, Attic & Basement and more), a free-quote booking widget, service-area band, an `#pricing` section, guarantees, why-us and an FAQ accordion
