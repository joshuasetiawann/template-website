# VoltLine Electric — Electrician Template

VoltLine Electric is a complete, four-page electrician website template — a bold-urgent design with a full services listing, an interactive quote/booking widget, transparent pricing and a validated contact flow, all in pure HTML, CSS and vanilla JavaScript.
...
- `services.html` — the primary page: breadcrumb, hero, the full Electrician services listing (Emergency Electrical Repair, Panel Upgrades & Rewiring, Lighting Design & Install and more), a free-quote booking widget, service-area band, an `#pricing` section, guarantees, why-us and an FAQ accordion
