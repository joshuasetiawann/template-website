# Aperture Collective — Photography Workshop Template

A two-page photography workshop website template with an admissions flow, full curriculum detail, and a bootcamp dark visual design.
