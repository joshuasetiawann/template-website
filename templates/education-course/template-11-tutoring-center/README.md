# BrightPath Tutoring — Tutoring Center Template

A two-page tutoring center website template with an admissions flow, full curriculum detail, and a modern academy visual design.
