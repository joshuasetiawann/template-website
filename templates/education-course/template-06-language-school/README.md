# Linguava Language School — Language School Template

A two-page language school website template with an admissions flow, full curriculum detail, and a modern academy visual design.
