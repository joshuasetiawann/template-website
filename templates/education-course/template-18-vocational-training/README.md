# TradeWorks Institute — Vocational Training Template

A two-page vocational training website template with an admissions flow, full curriculum detail, and a modern academy visual design.
