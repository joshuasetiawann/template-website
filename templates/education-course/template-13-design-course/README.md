# Prism Design School — Design Course Template

A two-page design course website template with an admissions flow, full curriculum detail, and a bootcamp dark visual design.
