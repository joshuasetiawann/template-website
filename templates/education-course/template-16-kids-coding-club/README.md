# PixelPals Coding Club — Kids Coding Club Template

A two-page kids coding club website template with an admissions flow, full curriculum detail, and a playful kids visual design.
