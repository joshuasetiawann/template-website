# Skillwave — Online Course Marketplace Template

A two-page online course marketplace website template with an admissions flow, full curriculum detail, and a modern academy visual design.
...
- Interactive category chip filters + search.
...
- **programs.html** — the “Course Catalog” page: a breadcrumb, an expanded block for each program (overview, modules, learning outcomes, schedule, tuition, and entry requirements), an admissions timeline, an FAQ, and a closing call to action.
